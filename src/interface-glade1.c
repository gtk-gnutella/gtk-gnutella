...
create_main_window (void)
{
  ...
  frame_expert_nw_misc = gtk_frame_new ("Miscellaneous");
  ...
  label441 = gtk_label_new ("Max file descriptors reserved for banning");
  ...
  label442 = gtk_label_new ("Max % of file descriptors used for banning");
