...
create_main_window (void)
{
  ...
  label_node_vendor = gtk_label_new ("User-agent");
  ...
  label_node_connected = gtk_label_new ("Connected");
  ...
  label_node_uptime = gtk_label_new ("Uptime");
  ...
  label_node_info = gtk_label_new ("Info");
  ...
  gtk_box_pack_start (GTK_BOX (vbox104), hbox_normal_or_ultrapeer, TRUE, TRUE, 0);
  ...
  hbox_leaf = gtk_hbox_new (FALSE, 4);
  ...
  gtk_box_pack_start (GTK_BOX (vbox104), hbox_leaf, TRUE, TRUE, 0);

  label449 = gtk_label_new ("Connect to");
  gtk_widget_set_name (label449, "label449");
  gtk_widget_ref (label449);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label449", label449,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label449);
  gtk_box_pack_start (GTK_BOX (hbox_leaf), label449, FALSE, FALSE, 0);
  gtk_misc_set_alignment (GTK_MISC (label449), 1, 0.5);
  ...
  label450 = gtk_label_new ("ultrapeers");
  gtk_widget_set_name (label450, "label450");
  gtk_widget_ref (label450);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label450", label450,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label450);
  gtk_box_pack_start (GTK_BOX (hbox_leaf), label450, FALSE, FALSE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox83), notebook4, TRUE, TRUE, 0);
  ...
  gtk_container_add (GTK_CONTAINER (notebook4), table11);
  ...
  label453 = gtk_label_new ("Normal hosts");
  ...
  gtk_progress_set_format_string (GTK_PROGRESS (progressbar_hosts_in_ultra_catcher), "%v/%u (%P%%)");

  button_ultra_catcher_clear = gtk_button_new_with_label ("Clear");
  ...
  label454 = gtk_label_new ("Ultrapeers");
  ...
  label451 = gtk_label_new ("Host catcher");
  ...
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook4), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook4), 0), label451);
  ...
  gtk_container_add (GTK_CONTAINER (notebook4), table37);
  ...
  label12 = gtk_label_new ("Uploaded");
  ...
  label11 = gtk_label_new ("Downloaded");
  ...
  label452 = gtk_label_new ("Transfered files");
  ...
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook4), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook4), 1), label452);
  ...
  gtk_box_pack_start (GTK_BOX (vbox83), frame14, TRUE, TRUE, 0);
  ...
  label510 = gtk_label_new ("Downloads");
  ...
  frame76 = gtk_frame_new ("Fileinfo");
  ...
  gtk_paned_pack1 (GTK_PANED (vpaned1), scrolledwindow42, FALSE, TRUE);
  ...
  label515 = gtk_label_new ("Sources");
  ...
  frame78 = gtk_frame_new ("Detail information");
  ...
  label_fi_filename = gtk_label_new ("[filename]");
  ...
  label_fi_size = gtk_label_new ("[size]");
  ...
  gtk_object_set_data_full (GTK_OBJECT (main_window), "notebook6", notebook6,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (notebook6);
  gtk_box_pack_start (GTK_BOX (vbox110), notebook6, TRUE, TRUE, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (main_window), "scrolledwindow43", scrolledwindow43,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (scrolledwindow43);
  gtk_container_add (GTK_CONTAINER (notebook6), scrolledwindow43);

  clist_fi_sources = gtk_clist_new (4);
  gtk_widget_set_name (clist_fi_sources, "clist_fi_sources");
  gtk_widget_ref (clist_fi_sources);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "clist_fi_sources", clist_fi_sources,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (clist_fi_sources);
  gtk_container_add (GTK_CONTAINER (scrolledwindow43), clist_fi_sources);
  gtk_clist_set_column_width (GTK_CLIST (clist_fi_sources), 0, 80);
  gtk_clist_set_column_width (GTK_CLIST (clist_fi_sources), 1, 80);
  gtk_clist_set_column_width (GTK_CLIST (clist_fi_sources), 2, 80);
  gtk_clist_set_column_width (GTK_CLIST (clist_fi_sources), 3, 80);
  gtk_clist_column_titles_show (GTK_CLIST (clist_fi_sources));

  label519 = gtk_label_new ("Host");
  gtk_widget_set_name (label519, "label519");
  gtk_widget_ref (label519);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label519", label519,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label519);
  gtk_clist_set_column_widget (GTK_CLIST (clist_fi_sources), 0, label519);

  label520 = gtk_label_new ("Server");
  gtk_widget_set_name (label520, "label520");
  gtk_widget_ref (label520);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label520", label520,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label520);
  gtk_clist_set_column_widget (GTK_CLIST (clist_fi_sources), 1, label520);

  label521 = gtk_label_new ("Range");
  gtk_widget_set_name (label521, "label521");
  gtk_widget_ref (label521);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label521", label521,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label521);
  gtk_clist_set_column_widget (GTK_CLIST (clist_fi_sources), 2, label521);

  label522 = gtk_label_new ("Status");
  gtk_widget_set_name (label522, "label522");
  gtk_widget_ref (label522);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label522", label522,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label522);
  gtk_clist_set_column_widget (GTK_CLIST (clist_fi_sources), 3, label522);

  label517 = gtk_label_new ("Sources");
  gtk_widget_set_name (label517, "label517");
  gtk_widget_ref (label517);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label517", label517,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label517);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook6), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook6), 0), label517);
  ...
  gtk_container_add (GTK_CONTAINER (notebook6), scrolledwindow44);
  ...
  label526 = gtk_label_new ("label526");
  ...
  label518 = gtk_label_new ("Aliases");
  gtk_widget_set_name (label518, "label518");
  gtk_widget_ref (label518);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label518", label518,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label518);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (notebook6), gtk_notebook_get_nth_page (GTK_NOTEBOOK (notebook6), 1), label518);

  label511 = gtk_label_new ("Fileinfo");
  ...
  gtk_container_add (GTK_CONTAINER (frame_search_results_settings), table34);
  ...
  gtk_table_attach (GTK_TABLE (table34), checkbutton_search_autoselect_ident, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  label460 = gtk_label_new ("Maximum results per search");
  ...
  gtk_table_attach (GTK_TABLE (table34), label460, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table34), spinbutton_search_max_results, 2, 3, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox52), button_search_download, FALSE, FALSE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox52), button_search_clear, FALSE, FALSE, 0);
  ...
  button_search_filter = gtk_button_new_with_label ("Edit filters");
  ...
  frame_expert_nw_local = gtk_frame_new ("Local networks");
  ...
  checkbutton_config_no_rfc1918 = gtk_check_button_new_with_label ("Allow connections from and to LAN addresses");
  ...
  label126_2 = gtk_label_new ("Local network(s)");
  ...
  frame_expert_nw_misc = gtk_frame_new ("Banning");
  ...
  label441 = gtk_label_new ("Max file descriptors reserved");
  ...
  label442 = gtk_label_new ("Max % of file descriptors used");
  ...
  label502 = gtk_label_new ("Hardlimit of file descriptors used");
  ...
  checkbutton_config_bw_allow_stealing = gtk_check_button_new_with_label ("Use surplus bandwidth");
  ...
  gtk_table_attach (GTK_TABLE (table49), checkbutton_config_bw_allow_stealing, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table49), checkbutton_prefer_compressed_gnet, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  checkbutton_config_use_ip_tos = gtk_check_button_new_with_label ("Use IP Type of Service (TOS)");
  ...
  frame74 = gtk_frame_new ("Ultrapeer mode");
  ...
  label36 = gtk_label_new ("kbit/s to peers");
  ...
  frame71 = gtk_frame_new ("Gnutella network mode");
  ...
  gtk_object_set_data_full (GTK_OBJECT (main_window), "vbox103", vbox103,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox103);
  gtk_container_add (GTK_CONTAINER (frame71), vbox103);
  ...
  gtk_object_set_data_full (GTK_OBJECT (main_window), "table55", table55,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table55);
  gtk_box_pack_start (GTK_BOX (vbox103), table55, FALSE, TRUE, 0);
  gtk_table_set_row_spacings (GTK_TABLE (table55), 2);
  gtk_table_set_col_spacings (GTK_TABLE (table55), 4);

  label439 = gtk_label_new ("Current peermode");
  ...
  gtk_table_attach (GTK_TABLE (table55), label439, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table55), combo_config_peermode, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  frame72 = gtk_frame_new ("Ultrapeer mode settings");
  ...
  gtk_box_pack_start (GTK_BOX (vbox103), frame72, FALSE, TRUE, 0);
  ...
  label459 = gtk_label_new ("Legacy connections");
  ...
  label504 = gtk_label_new ("Maximum # of leaves");
  ...
  frame_expert_gnet_timeout = gtk_frame_new ("gnutellaNet timeouts (all values in seconds)");
  ...
  label503 = gtk_label_new ("Incoming connecting timeout");
  ...
  frame_expert_gnet_ttl = gtk_frame_new ("gnutellaNet TTL settings");
  ...
  frame_expert_gnet_quality = gtk_frame_new ("Quality management");
  ...
  label457 = gtk_label_new ("RX flow control ratio");
  ...
  checkbutton_gnet_compact_query = gtk_check_button_new_with_label ("Clean up queries before processing");
  ...
  gtk_table_attach (GTK_TABLE (table33), checkbutton_gnet_compact_query, 2, 3, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  frame66 = gtk_frame_new ("Move corrupted downloaded files to");
  ...
  button_config_bad_path = gtk_button_new_with_label ("Browse");
  ...
  frame48 = gtk_frame_new ("Downloading from mutiple sources (swarming)");
  ...
  frame_expert_ul_timeout = gtk_frame_new ("Timeouts (all values in seconds)");
  ...
  checkbutton_config_confirm_quit = gtk_check_button_new_with_label ("show confirmation dialog when leaving gtk-gnutella");
  ...
  checkbutton_config_show_tooltips = gtk_check_button_new_with_label ("show tooltips (does not affect all tooltips yet)");
  ...
  frame64 = gtk_frame_new ("Expert mode");
  ...
  checkbutton_expert_mode = gtk_check_button_new_with_label ("Allow experimenting with low-level settings");
  ...
  table57 = gtk_table_new (11, 2, FALSE);
  ...
  label468_key = gtk_label_parse_uline (GTK_LABEL (label468),
                                   "PROP__AVERAGE__SERVENT__UPTIME");
  ...
  label476 = gtk_label_new ("");
  label476_key = gtk_label_parse_uline (GTK_LABEL (label476),
                                   "PROP__FORCE__ULTRAPEER");
  gtk_widget_set_name (label476, "label476");
  gtk_widget_ref (label476);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label476", label476,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label476);
  gtk_table_attach (GTK_TABLE (table57), label476, 0, 1, 6, 7,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label476), 0, 0.5);

  label477 = gtk_label_new ("");
  label477_key = gtk_label_parse_uline (GTK_LABEL (label477),
                                   "PROP__FORCE__LEAF");
  gtk_widget_set_name (label477, "label477");
  gtk_widget_ref (label477);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "label477", label477,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label477);
  gtk_table_attach (GTK_TABLE (table57), label477, 0, 1, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table57), label479, 0, 1, 8, 9,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table57), label480, 0, 1, 9, 10,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_widget_ref (entry_force_leaf);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "entry_force_leaf", entry_force_leaf,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (entry_force_leaf);
  gtk_table_attach (GTK_TABLE (table57), entry_force_leaf, 1, 2, 7, 8,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_editable (GTK_ENTRY (entry_force_leaf), FALSE);

  entry_force_ultrapeer = gtk_entry_new ();
  gtk_widget_set_name (entry_force_ultrapeer, "entry_force_ultrapeer");
  gtk_widget_ref (entry_force_ultrapeer);
  gtk_object_set_data_full (GTK_OBJECT (main_window), "entry_force_ultrapeer", entry_force_ultrapeer,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (entry_force_ultrapeer);
  gtk_table_attach (GTK_TABLE (table57), entry_force_ultrapeer, 1, 2, 6, 7,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_editable (GTK_ENTRY (entry_force_ultrapeer), FALSE);
  ...
  gtk_table_attach (GTK_TABLE (table57), entry_sys_nofile, 1, 2, 8, 9,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table57), entry_sys_physmem, 1, 2, 9, 10,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table57), label508, 0, 1, 10, 11,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table57), entry_crawler_visit_count, 1, 2, 10, 11,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_paned_set_handle_size (GTK_PANED (hpaned_gnet_stats), 8);
  ...
  frame69 = gtk_frame_new ("Message/flow control stats");
  ...
  label392 = gtk_label_new ("received");
  ...
  label393 = gtk_label_new ("expired");
  ...
  label394 = gtk_label_new ("dropped");
  ...
  label395 = gtk_label_new ("relayed");
  ...
  label396 = gtk_label_new ("generated");
  ...
  label436 = gtk_label_new ("Messages");
  ...
  label438 = gtk_label_new ("FC/hops");
  ...
  checkbutton_gnet_stats_perc = gtk_check_button_new_with_label ("show percentages");
  ...
  checkbutton_gnet_stats_bytes = gtk_check_button_new_with_label ("show bytes");
  ...
  gtk_widget_set_usize (frame65, -2, 170);
  ...
  frame56 = gtk_frame_new ("Drop reasons");
  ...
  label390 = gtk_label_new ("Show reasons for");
  ...
  gtk_signal_connect (GTK_OBJECT (clist_fileinfo), "resize_column",
                      ...
                      NULL);
  gtk_signal_connect (GTK_OBJECT (clist_fileinfo), "button_press_event",
                      GTK_SIGNAL_FUNC (on_clist_fileinfo_button_press_event),
                      NULL);
  ...
  gtk_widget_add_accelerator (entry_force_ultrapeer, "grab_focus", accel_group,
                              label476_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
  gtk_widget_add_accelerator (entry_force_leaf, "grab_focus", accel_group,
                              label477_key, GDK_MOD1_MASK, (GtkAccelFlags) 0);
...
create_popup_search (void)
{
  ...
  drop1 = gtk_menu_item_new_with_label ("Drop...");
  ...
  popup_search_drop_name = gtk_menu_item_new_with_label ("results with name");
  ...
  popup_search_drop_sha1 = gtk_menu_item_new_with_label ("results with urn:sha1");
  ...
  popup_search_drop_host = gtk_menu_item_new_with_label ("results from host");
  ...
  globally_drop1 = gtk_menu_item_new_with_label ("Globally drop...");
  ...
  popup_search_drop_name_global = gtk_menu_item_new_with_label ("results with name");
  ...
  popup_search_drop_sha1_global = gtk_menu_item_new_with_label ("results with urn:sha1");
  ...
  popup_search_drop_host_global = gtk_menu_item_new_with_label ("results from host");
  ...
  popup_search_new_from_selected = gtk_menu_item_new_with_label ("New search from selected");
...
create_dlg_filters (void)
{
  ...
  frame77 = gtk_frame_new ("Create a new filter");
  ...
  button_filter_create = gtk_button_new_with_label ("Create");
...
create_dlg_about (void)
{
  ...
  label265 = gtk_label_new ("Yann Grossel");
  ...
  label266 = gtk_label_new ("Project leader:");
  ...
  label272 = gtk_label_new ("Richard Eckart, Christian Biere");
...
create_dlg_quit (void)
{
  ...
  frame51 = gtk_frame_new ("Please confirm:");
  ...
  label295 = gtk_label_new ("Do you really want to quit?");
  ...
  button_really_quit = gtk_button_new_with_label ("Yes");
  ...
  button_abort_quit = gtk_button_new_with_label ("No, take me back!");
