...
prop_set_t *gnet_prop_init(void) {
     ...
     * General data:
     */
    gnet_property->props[36].name = "incoming_connecting_timeout";
    gnet_property->props[36].desc = "Number of seconds an incoming connection has to start sending out its request";
    ...
    gnet_property->props[36].data.guint32.def   = &incoming_connecting_timeout_def;
    gnet_property->props[36].data.guint32.value = &incoming_connecting_timeout;
    gnet_property->props[36].data.guint32.max   = 300;
     ...
     * General data:
     */
    gnet_property->props[37].name = "node_connecting_timeout";
    gnet_property->props[37].desc = "Number of seconds before a Gnet connect attempt times out if no connection can be established";
    ...
    gnet_property->props[37].data.guint32.def   = &node_connecting_timeout_def;
    gnet_property->props[37].data.guint32.value = &node_connecting_timeout;
     ...
     * General data:
     */
    gnet_property->props[38].name = "node_connected_timeout";
    gnet_property->props[38].desc = "Number of seconds before a Gnet connection times out if no data is transmitted";
    ...
    gnet_property->props[38].data.guint32.def   = &node_connected_timeout_def;
    gnet_property->props[38].data.guint32.value = &node_connected_timeout;
     ...
     * General data:
     */
    gnet_property->props[39].name = "node_sendqueue_size";
    gnet_property->props[39].desc = "Maximum size of the sendqueue for the nodes (in bytes). Must be at lest 150% of the maximum message size";
    ...
    gnet_property->props[39].data.guint32.def   = &node_sendqueue_size_def;
    gnet_property->props[39].data.guint32.value = &node_sendqueue_size;
    gnet_property->props[39].data.guint32.max   = 256000;
    gnet_property->props[39].data.guint32.min   = 98305;
     ...
     * General data:
     */
    gnet_property->props[40].name = "node_tx_flowc_timeout";
    gnet_property->props[40].desc = "Maximum number of seconds a node can remain in transmit flow control before being kicked out.";
    ...
    gnet_property->props[40].data.guint32.def   = &node_tx_flowc_timeout_def;
    gnet_property->props[40].data.guint32.value = &node_tx_flowc_timeout;
    gnet_property->props[40].data.guint32.max   = 100000;
    gnet_property->props[40].data.guint32.min   = 5;
     ...
     * General data:
     */
    gnet_property->props[41].name = "max_ttl";
    gnet_property->props[41].desc = "Maximum TTL we allow in messages we broadcast.  If a message comes in with a TTL greater than that, it will be trimmed down to that value.  On Gnutella, the standard is TTL=7, so you cannot set a value lower than that.";
    ...
    gnet_property->props[41].data.guint32.def   = &max_ttl_def;
    gnet_property->props[41].data.guint32.value = &max_ttl;
    gnet_property->props[41].data.guint32.max   = 20;
    gnet_property->props[41].data.guint32.min   = 7;
     ...
     * General data:
     */
    gnet_property->props[42].name = "my_ttl";
    gnet_property->props[42].desc = "The TTL we use in messages we generate.  The default on Gnutella is TTL=7.  If you set it to too large a value, you run the risk of being trimmed down by fellow gtk-gnutella nodes, or kicked out by some other servent.";
    ...
    gnet_property->props[42].data.guint32.def   = &my_ttl_def;
    gnet_property->props[42].data.guint32.value = &my_ttl;
    gnet_property->props[42].data.guint32.max   = 15;
     ...
     * General data:
     */
    gnet_property->props[43].name = "hard_ttl_limit";
    gnet_property->props[43].desc = "Maximum hard TTL limit (hops + TTL) on messages we relay.  This should be greater than the standard TTL=7, because it also applied to routed-back messages (query hits) that could be re-routed in case a connection is lost.  Standard broadcasted messages have their TTL limited by the maximum TTL you configure, and that limit should be much lower than the value of this parameter.";
    ...
    gnet_property->props[43].data.guint32.def   = &hard_ttl_limit_def;
    gnet_property->props[43].data.guint32.value = &hard_ttl_limit;
    gnet_property->props[43].data.guint32.max   = 25;
    gnet_property->props[43].data.guint32.min   = 9;
     ...
     * General data:
     */
    gnet_property->props[44].name = "dbg";
    gnet_property->props[44].desc = "For development use: debug level";
    ...
    gnet_property->props[44].data.guint32.def   = &dbg_def;
    gnet_property->props[44].data.guint32.value = &dbg;
    gnet_property->props[44].data.guint32.max   = 20;
     ...
     * General data:
     */
    gnet_property->props[45].name = "stop_host_get";
    gnet_property->props[45].desc = "For development use: don't add new hosts to the hostcatcher";
    ...
    gnet_property->props[45].data.boolean.def   = &stop_host_get_def;
    gnet_property->props[45].data.boolean.value = &stop_host_get;
     ...
     * General data:
     */
    gnet_property->props[46].name = "bandwidth_input_limit";
    gnet_property->props[46].desc = "Enable bandwidth limitation for incoming HTTP traffic";
    ...
    gnet_property->props[46].data.boolean.def   = &bws_in_enabled_def;
    gnet_property->props[46].data.boolean.value = &bws_in_enabled;
     ...
     * General data:
     */
    gnet_property->props[47].name = "bandwidth_output_limit";
    gnet_property->props[47].desc = "Enable bandwidth limitation for outgoing HTTP traffic";
    ...
    gnet_property->props[47].data.boolean.def   = &bws_out_enabled_def;
    gnet_property->props[47].data.boolean.value = &bws_out_enabled;
     ...
     * General data:
     */
    gnet_property->props[48].name = "bandwidth_ginput_limit";
    gnet_property->props[48].desc = "Enable bandwidth limitation for incoming Gnet traffic";
    ...
    gnet_property->props[48].data.boolean.def   = &bws_gin_enabled_def;
    gnet_property->props[48].data.boolean.value = &bws_gin_enabled;
     ...
     * General data:
     */
    gnet_property->props[49].name = "bandwidth_goutput_limit";
    gnet_property->props[49].desc = "Enable bandwidth limitation for outgoing Gnet traffic";
    ...
    gnet_property->props[49].data.boolean.def   = &bws_gout_enabled_def;
    gnet_property->props[49].data.boolean.value = &bws_gout_enabled;
     ...
     * General data:
     */
    gnet_property->props[50].name = "upload_bandwith_usage_enabled";
    gnet_property->props[50].desc = "Enable dynamic upload slots allocation";
    ...
    gnet_property->props[50].data.boolean.def   = &bw_ul_usage_enabled_def;
    gnet_property->props[50].data.boolean.value = &bw_ul_usage_enabled;
     ...
     * General data:
     */
    gnet_property->props[51].name = "auto_clear_completed_downloads";
    gnet_property->props[51].desc = "Auto clear completed downloads";
    ...
    gnet_property->props[51].data.boolean.def   = &clear_downloads_def;
    gnet_property->props[51].data.boolean.value = &clear_downloads;
     ...
     * General data:
     */
    gnet_property->props[52].name = "search_remove_downloaded";
    gnet_property->props[52].desc = "Remove downloaded files from the search result";
    ...
    gnet_property->props[52].data.boolean.def   = &search_remove_downloaded_def;
    gnet_property->props[52].data.boolean.value = &search_remove_downloaded;
     ...
     * General data:
     */
    gnet_property->props[53].name = "force_local_ip";
    gnet_property->props[53].desc = "Enable to use [forced_local_ip] as local ip";
    ...
    gnet_property->props[53].data.boolean.def   = &force_local_ip_def;
    gnet_property->props[53].data.boolean.value = &force_local_ip;
     ...
     * General data:
     */
    gnet_property->props[54].name = "use_netmasks";
    gnet_property->props[54].desc = "Try to connect to local networks first";
    ...
    gnet_property->props[54].data.boolean.def   = &use_netmasks_def;
    gnet_property->props[54].data.boolean.value = &use_netmasks;
     ...
     * General data:
     */
    gnet_property->props[55].name = "download_delete_aborted";
    gnet_property->props[55].desc = "Remove files of aborted downloads from disk";
    ...
    gnet_property->props[55].data.boolean.def   = &download_delete_aborted_def;
    gnet_property->props[55].data.boolean.value = &download_delete_aborted;
     ...
     * General data:
     */
    gnet_property->props[56].name = "proxy_connections";
    gnet_property->props[56].desc = "Use a proxy to connect to the internet";
    ...
    gnet_property->props[56].data.boolean.def   = &proxy_connections_def;
    gnet_property->props[56].data.boolean.value = &proxy_connections;
     ...
     * General data:
     */
    gnet_property->props[57].name = "proxy_auth";
    gnet_property->props[57].desc = "Use username and password to authenticate to proxy";
    ...
    gnet_property->props[57].data.boolean.def   = &proxy_auth_def;
    gnet_property->props[57].data.boolean.value = &proxy_auth;
     ...
     * General data:
     */
    gnet_property->props[58].name = "socks_user";
    gnet_property->props[58].desc = "Username for proxy";
    gnet_property->props[58].prop_changed_listeners = NULL;
    gnet_property->props[58].save = TRUE;
    gnet_property->props[58].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[58].type               = PROP_TYPE_STRING;
    gnet_property->props[58].data.string.def    = &socks_user_def;
    gnet_property->props[58].data.string.value  = &socks_user;
    if (gnet_property->props[58].data.string.def) {
        *gnet_property->props[58].data.string.value =
            g_strdup(*gnet_property->props[58].data.string.def);
    }
     ...
     * General data:
     */
    gnet_property->props[59].name = "socks_pass";
    gnet_property->props[59].desc = "Password for proxy";
    gnet_property->props[59].prop_changed_listeners = NULL;
    gnet_property->props[59].save = TRUE;
    gnet_property->props[59].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[59].type               = PROP_TYPE_STRING;
    gnet_property->props[59].data.string.def    = &socks_pass_def;
    gnet_property->props[59].data.string.value  = &socks_pass;
    if (gnet_property->props[59].data.string.def) {
        *gnet_property->props[59].data.string.value =
            g_strdup(*gnet_property->props[59].data.string.def);
    }
     ...
     * General data:
     */
    gnet_property->props[60].name = "proxy_ip";
    gnet_property->props[60].desc = "IP address of the proxy";
    gnet_property->props[60].prop_changed_listeners = NULL;
    gnet_property->props[60].save = TRUE;
    gnet_property->props[60].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[60].type               = PROP_TYPE_IP;
    gnet_property->props[60].data.guint32.def   = &proxy_ip_def;
    gnet_property->props[60].data.guint32.value = &proxy_ip;
     ...
     * General data:
     */
    gnet_property->props[61].name = "proxy_port";
    gnet_property->props[61].desc = "Port the proxy is listening on";
    ...
    gnet_property->props[61].data.guint32.def   = &proxy_port_def;
    gnet_property->props[61].data.guint32.value = &proxy_port;
    gnet_property->props[61].data.guint32.max   = 0xFFFF;
    gnet_property->props[61].data.guint32.min   = 0x0000;
     ...
     * General data:
     */
    gnet_property->props[62].name = "proxy_protocol";
    gnet_property->props[62].desc = "Protocol the proxy uses";
    ...
    gnet_property->props[62].data.guint32.def   = &proxy_protocol_def;
    gnet_property->props[62].data.guint32.value = &proxy_protocol;
    gnet_property->props[62].data.guint32.max   = 0x5;
    gnet_property->props[62].data.guint32.min   = 0x1;
     ...
     * General data:
     */
    gnet_property->props[63].name = "max_hosts_cached";
    gnet_property->props[63].desc = "Maximum number of hosts in the regular node catcher";
    ...
    gnet_property->props[63].data.guint32.def   = &max_hosts_cached_def;
    gnet_property->props[63].data.guint32.value = &max_hosts_cached;
    gnet_property->props[63].data.guint32.max   = 100000;
    gnet_property->props[63].data.guint32.min   = 100;
     ...
     * General data:
     */
    gnet_property->props[64].name = "hosts_in_catcher";
    gnet_property->props[64].desc = "Current number of hosts in regular node catcher";
    gnet_property->props[64].prop_changed_listeners = NULL;
    gnet_property->props[64].save = FALSE;
    gnet_property->props[64].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[64].type               = PROP_TYPE_GUINT32;
    gnet_property->props[64].data.guint32.def   = &hosts_in_catcher_def;
    gnet_property->props[64].data.guint32.value = &hosts_in_catcher;
     ...
     * General data:
     */
    gnet_property->props[65].name = "hosts_in_ultra_catcher";
    gnet_property->props[65].desc = "Current number of hosts in ultra node catcher";
    ...
    gnet_property->props[65].data.guint32.def   = &hosts_in_ultra_catcher_def;
    gnet_property->props[65].data.guint32.value = &hosts_in_ultra_catcher;
     ...
     * General data:
     */
    gnet_property->props[66].name = "max_ultra_hosts_cached";
    gnet_property->props[66].desc = "Maximum number of hosts in the ultra node catcher";
    ...
    gnet_property->props[66].data.guint32.def   = &max_ultra_hosts_cached_def;
    gnet_property->props[66].data.guint32.value = &max_ultra_hosts_cached;
     ...
     * General data:
     */
    gnet_property->props[67].name = "max_high_ttl_msg";
    gnet_property->props[67].desc = "Amount of tolerable messages above hard TTL limit per node. See also MAX_HIGH_TTL_RADIUS";
    ...
    gnet_property->props[67].data.guint32.def   = &max_high_ttl_msg_def;
    gnet_property->props[67].data.guint32.value = &max_high_ttl_msg;
    gnet_property->props[67].data.guint32.max   = 10000;
     ...
     * General data:
     */
    gnet_property->props[68].name = "max_high_ttl_radius";
    gnet_property->props[68].desc = "Hop radius for counting high TTL limit messages (# hops lower than...) See also MAX_HIGH_TTL_MSG";
    ...
    gnet_property->props[68].data.guint32.def   = &max_high_ttl_radius_def;
    gnet_property->props[68].data.guint32.value = &max_high_ttl_radius;
    gnet_property->props[68].data.guint32.max   = 10;
     ...
     * General data:
     */
    gnet_property->props[69].name = "input_bandwidth";
    gnet_property->props[69].desc = "Bandwidth limit for incoming HTTP traffic in bytes/sec";
    ...
    gnet_property->props[69].data.guint32.def   = &bw_http_in_def;
    gnet_property->props[69].data.guint32.value = &bw_http_in;
    gnet_property->props[69].data.guint32.max   = BS_BW_MAX;
    gnet_property->props[69].data.guint32.min   = 1024;
     ...
     * General data:
     */
    gnet_property->props[70].name = "output_bandwidth";
    gnet_property->props[70].desc = "Bandwidth limit for outgoing HTTP traffic in bytes/sec";
    ...
    gnet_property->props[70].data.guint32.def   = &bw_http_out_def;
    gnet_property->props[70].data.guint32.value = &bw_http_out;
     ...
     * General data:
     */
    gnet_property->props[71].name = "input_gnet_bandwidth";
    gnet_property->props[71].desc = "Bandwidth limit for incoming gNet traffic in bytes/sec";
    ...
    gnet_property->props[71].data.guint32.def   = &bw_gnet_in_def;
    gnet_property->props[71].data.guint32.value = &bw_gnet_in;
     ...
     * General data:
     */
    gnet_property->props[72].name = "output_gnet_bandwidth";
    gnet_property->props[72].desc = "Bandwidth limit for outgoing gNet traffic in bytes/sec";
    ...
    gnet_property->props[72].data.guint32.def   = &bw_gnet_out_def;
    gnet_property->props[72].data.guint32.value = &bw_gnet_out;
     ...
     * General data:
     */
    gnet_property->props[73].name = "search_queries_forward_size";
    gnet_property->props[73].desc = "Maximum size of search queries messages we forward to others  (in bytes)";
    ...
    gnet_property->props[73].data.guint32.def   = &search_queries_forward_size_def;
    gnet_property->props[73].data.guint32.value = &search_queries_forward_size;
    gnet_property->props[73].data.guint32.max   = 65536;
    gnet_property->props[73].data.guint32.min   = 64;
     ...
     * General data:
     */
    gnet_property->props[74].name = "search_queries_kick_size";
    gnet_property->props[74].desc = "Maximum size of search queries messages we allow, otherwise close the connection (in bytes)";
    ...
    gnet_property->props[74].data.guint32.def   = &search_queries_kick_size_def;
    gnet_property->props[74].data.guint32.value = &search_queries_kick_size;
    gnet_property->props[74].data.guint32.max   = 65536;
    gnet_property->props[74].data.guint32.min   = 128;
     ...
     * General data:
     */
    gnet_property->props[75].name = "search_answers_forward_size";
    gnet_property->props[75].desc = "Maximum size of search answers messages we forward to others (in bytes)";
    ...
    gnet_property->props[75].data.guint32.def   = &search_answers_forward_size_def;
    gnet_property->props[75].data.guint32.value = &search_answers_forward_size;
    gnet_property->props[75].data.guint32.max   = 65536;
    gnet_property->props[75].data.guint32.min   = 2048;
     ...
     * General data:
     */
    gnet_property->props[76].name = "search_answers_kick_size";
    gnet_property->props[76].desc = "Maximum size of search answers messages we allow, otherwise close the connection (in bytes)";
    ...
    gnet_property->props[76].data.guint32.def   = &search_answers_kick_size_def;
    gnet_property->props[76].data.guint32.value = &search_answers_kick_size;
     ...
     * General data:
     */
    gnet_property->props[77].name = "other_messages_kick_size";
    gnet_property->props[77].desc = "Maximum size of unknown messages we allow, otherwise close the connection (in bytes)";
    ...
    gnet_property->props[77].data.guint32.def   = &other_messages_kick_size_def;
    gnet_property->props[77].data.guint32.value = &other_messages_kick_size;
    gnet_property->props[77].data.guint32.max   = 65536;
    gnet_property->props[77].data.guint32.min   = 256;
     ...
     * General data:
     */
    gnet_property->props[78].name = "hops_random_factor";
    gnet_property->props[78].desc = "Random factor for the hops field in search packets we send between 0 and 3 inclusive)";
    ...
    gnet_property->props[78].data.guint32.def   = &hops_random_factor_def;
    gnet_property->props[78].data.guint32.value = &hops_random_factor;
    gnet_property->props[78].data.guint32.max   = 3;
     ...
     * General data:
     */
    gnet_property->props[79].name = "send_pushes";
    gnet_property->props[79].desc = "Whether or not to send push requests.  If you are firewalled, gtk-gnutella will never send push requests anyway.  If you don't let gtk-gnutella send pushes, it will not show search results that would require a push.";
    ...
    gnet_property->props[79].data.boolean.def   = &send_pushes_def;
    gnet_property->props[79].data.boolean.value = &send_pushes;
     ...
     * General data:
     */
    gnet_property->props[80].name = "min_dup_msg";
    gnet_property->props[80].desc = "Minimum amount of dup messages to enable kicking, per node (also see [min_dup_ratio])";
    ...
    gnet_property->props[80].data.guint32.def   = &min_dup_msg_def;
    gnet_property->props[80].data.guint32.value = &min_dup_msg;
    gnet_property->props[80].data.guint32.max   = 99;
    gnet_property->props[80].data.guint32.min   = 1;
     ...
     * General data:
     */
    gnet_property->props[81].name = "min_dup_ratio";
    gnet_property->props[81].desc = "Minimum ratio of dups on received messages, per node (between 0.00 and 100.00) (also see [min_dup_msg]) Note: the value is stored between 0 (0.0) and 10000 (100.0) in the config file";
    ...
    gnet_property->props[81].data.guint32.def   = &min_dup_ratio_def;
    gnet_property->props[81].data.guint32.value = &min_dup_ratio;
     ...
     * General data:
     */
    gnet_property->props[82].name = "shared_files_extensions";
    gnet_property->props[82].desc = "Only files with the given extensions will be shared. The special --all-- extension matches all files, even if they don't have any extension.  Use with care.";
    ...
    gnet_property->props[82].data.string.def    = &scan_extensions_def;
    gnet_property->props[82].data.string.value  = &scan_extensions;
     ...
     * General data:
     */
    gnet_property->props[83].name = "store_downloading_files_to";
    gnet_property->props[83].desc = "Store incomplete files in this directory";
    ...
    gnet_property->props[83].data.string.def    = &save_file_path_def;
    gnet_property->props[83].data.string.value  = &save_file_path;
     ...
     * General data:
     */
    gnet_property->props[84].name = "move_downloading_files_to";
    gnet_property->props[84].desc = "Move complete files to this directory. If this is set to the SAME directory as the incomplete or corrupted files, files will be renamed with a trailing .OK";
    ...
    gnet_property->props[84].data.string.def    = &move_file_path_def;
    gnet_property->props[84].data.string.value  = &move_file_path;
    if (gnet_property->props[84].data.string.def) {
        *gnet_property->props[84].data.string.value =
            g_strdup(*gnet_property->props[84].data.string.def);
    }
     ...
     * General data:
     */
    gnet_property->props[85].name = "move_corrupted_files_to";
    gnet_property->props[85].desc = "Move corrupted downloaded files in this directory. If this is set to the SAME directory as the incomplete or completed files, files will be renamed with a trailing .BAD";
    ...
    gnet_property->props[85].data.string.def    = &bad_file_path_def;
    gnet_property->props[85].data.string.value  = &bad_file_path;
     ...
     * General data:
     */
    gnet_property->props[86].name = "shared_dirs";
    gnet_property->props[86].desc = "Directories which contain shared files";
    ...
    gnet_property->props[86].data.string.def    = &shared_dirs_paths_def;
    gnet_property->props[86].data.string.value  = &shared_dirs_paths;
     ...
     * General data:
     */
    gnet_property->props[87].name = "local_netmasks";
    gnet_property->props[87].desc = "List of networks considered local.  This is a list of IP addresses, separated by ';'.  The IP address can be given out fully, as in 192.168.0.1, or be optionally followed by '/' and a network mask prefix length. For instance, 192.168.0.1/24 would represent the whole 192.168.0.* network.";
    ...
    gnet_property->props[87].data.string.def    = &local_netmasks_string_def;
    gnet_property->props[87].data.string.value  = &local_netmasks_string;
     ...
     * General data:
     */
    gnet_property->props[88].name = "total_downloads";
    gnet_property->props[88].desc = "Total number of completed downloads in this session";
    ...
    gnet_property->props[88].data.guint32.def   = &total_downloads_def;
    gnet_property->props[88].data.guint32.value = &total_downloads;
     ...
     * General data:
     */
    gnet_property->props[89].name = "total_uploads";
    gnet_property->props[89].desc = "Total number of completed uploads in this session";
    ...
    gnet_property->props[89].data.guint32.def   = &total_uploads_def;
    gnet_property->props[89].data.guint32.value = &total_uploads;
     ...
     * General data:
     */
    gnet_property->props[90].name = "guid";
    gnet_property->props[90].desc = "Global Unique IDentifier of this node";
    gnet_property->props[90].prop_changed_listeners = NULL;
    gnet_property->props[90].save = TRUE;
    gnet_property->props[90].vector_size = 16;

    /* Type specific data: */
    gnet_property->props[90].type               = PROP_TYPE_STORAGE;
    gnet_property->props[90].data.storage.value = guid;
    memset(guid, 0, gnet_property->props[90].vector_size);
     ...
     * General data:
     */
    gnet_property->props[91].name = "use_swarming";
    gnet_property->props[91].desc = "Wether or not to use swarming (recommended = YES)";
    ...
    gnet_property->props[91].data.boolean.def   = &use_swarming_def;
    gnet_property->props[91].data.boolean.value = &use_swarming;
     ...
     * General data:
     */
    gnet_property->props[92].name = "use_aggressive_swarming";
    gnet_property->props[92].desc = "Whether or not to launch competing downloads when swarming and there are many sources available with a few chunks left.";
    ...
    gnet_property->props[92].data.boolean.def   = &use_aggressive_swarming_def;
    gnet_property->props[92].data.boolean.value = &use_aggressive_swarming;
     ...
     * General data:
     */
    gnet_property->props[93].name = "dl_minchunksize";
    gnet_property->props[93].desc = "Minimum chunk size when swarming.  This is only a hint as gtk-gnutella will download less if you only have a few bytes to get for a file...";
    ...
    gnet_property->props[93].data.guint32.def   = &dl_minchunksize_def;
    gnet_property->props[93].data.guint32.value = &dl_minchunksize;
    gnet_property->props[93].data.guint32.max   = 100*1024*1024;
    gnet_property->props[93].data.guint32.min   = 64*1024;
     ...
     * General data:
     */
    gnet_property->props[94].name = "dl_maxchunksize";
    gnet_property->props[94].desc = "Maximum chunk size when swarming";
    ...
    gnet_property->props[94].data.guint32.def   = &dl_maxchunksize_def;
    gnet_property->props[94].data.guint32.value = &dl_maxchunksize;
    gnet_property->props[94].data.guint32.max   = 1000*1024*1024;
     ...
     * General data:
     */
    gnet_property->props[95].name = "auto_download_identical";
    gnet_property->props[95].desc = "Wether or not to automatically queue search results that match a file in the download queue";
    ...
    gnet_property->props[95].data.boolean.def   = &auto_download_identical_def;
    gnet_property->props[95].data.boolean.value = &auto_download_identical;
     ...
     * General data:
     */
    gnet_property->props[96].name = "strict_sha1_matching";
    gnet_property->props[96].desc = "When enabled, SHA1s must match. Otherwise, name and size will be sufficient";
    ...
    gnet_property->props[96].data.boolean.def   = &strict_sha1_matching_def;
    gnet_property->props[96].data.boolean.value = &strict_sha1_matching;
     ...
     * General data:
     */
    gnet_property->props[97].name = "use_fuzzy_matching";
    gnet_property->props[97].desc = "Use fuzzy file name matching (recommended = NO; only rely on SHA1 matching to be safe)";
    ...
    gnet_property->props[97].data.boolean.def   = &use_fuzzy_matching_def;
    gnet_property->props[97].data.boolean.value = &use_fuzzy_matching;
     ...
     * General data:
     */
    gnet_property->props[98].name = "fuzzy_threshold";
    gnet_property->props[98].desc = "Fuzziness threshold for filename matching (higher = stricter). A value of 100 means the filenames must be 100% identical.  A value of 0 means any two filenames will always be considered to be identical.  The minimum is 50%.";
    ...
    gnet_property->props[98].data.guint32.def   = &fuzzy_threshold_def;
    gnet_property->props[98].data.guint32.value = &fuzzy_threshold;
    gnet_property->props[98].data.guint32.max   = 100;
    gnet_property->props[98].data.guint32.min   = 50;
     ...
     * General data:
     */
    gnet_property->props[99].name = "is_firewalled";
    gnet_property->props[99].desc = "Whether gtk-gnutella thinks we're currently firewalled";
    ...
    gnet_property->props[99].data.boolean.def   = &is_firewalled_def;
    gnet_property->props[99].data.boolean.value = &is_firewalled;
     ...
     * General data:
     */
    gnet_property->props[100].name = "is_inet_connected";
    gnet_property->props[100].desc = "Whether gtk-gnutella thinks it's connected to the Internet";
    ...
    gnet_property->props[100].data.boolean.def   = &is_inet_connected_def;
    gnet_property->props[100].data.boolean.value = &is_inet_connected;
     ...
     * General data:
     */
    gnet_property->props[101].name = "gnet_compact_query";
    gnet_property->props[101].desc = "Remove unnecessary ballast from query string before processing or forwarding them. Reduces traffic at the cost of little CPU time";
    ...
    gnet_property->props[101].data.boolean.def   = &gnet_compact_query_def;
    gnet_property->props[101].data.boolean.value = &gnet_compact_query;
     ...
     * General data:
     */
    gnet_property->props[102].name = "download_optimistic_start";
    gnet_property->props[102].desc = "Also use sources that don't provide a SHA1 value for the first chunk of a file. This dramatically reduces the 'No URN on server' messages, but may result in overlap problems later if the first chunk was actually from a different file. Use with caution.";
    ...
    gnet_property->props[102].data.boolean.def   = &download_optimistic_start_def;
    gnet_property->props[102].data.boolean.value = &download_optimistic_start;
     ...
     * General data:
     */
    gnet_property->props[103].name = "mark_ignored";
    gnet_property->props[103].desc = "Mark files that would be ignored when downloaded. This uses a little additional CPU power so it's off by default. If you don't have a very slow box, you might want to turn this on.";
    ...
    gnet_property->props[103].data.boolean.def   = &mark_ignored_def;
    gnet_property->props[103].data.boolean.value = &mark_ignored;
     ...
     * General data:
     */
    gnet_property->props[104].name = "library_rebuilding";
    gnet_property->props[104].desc = "Whether gtk-gnutella is currently rebuilding its library in the background";
    ...
    gnet_property->props[104].data.boolean.def   = &library_rebuilding_def;
    gnet_property->props[104].data.boolean.value = &library_rebuilding;
     ...
     * General data:
     */
    gnet_property->props[105].name = "sha1_rebuilding";
    gnet_property->props[105].desc = "Whether gtk-gnutella is currently computing SHA1 of shared files in the background";
    ...
    gnet_property->props[105].data.boolean.def   = &sha1_rebuilding_def;
    gnet_property->props[105].data.boolean.value = &sha1_rebuilding;
     ...
     * General data:
     */
    gnet_property->props[106].name = "sha1_verifying";
    gnet_property->props[106].desc = "Whether gtk-gnutella is currently verifying SHA1 of downloaded files in the background";
    ...
    gnet_property->props[106].data.boolean.def   = &sha1_verifying_def;
    gnet_property->props[106].data.boolean.value = &sha1_verifying;
     ...
     * General data:
     */
    gnet_property->props[107].name = "file_moving";
    gnet_property->props[107].desc = "Whether gtk-gnutella is currently moving files accross filesystems or simply copying in the background";
    ...
    gnet_property->props[107].data.boolean.def   = &file_moving_def;
    gnet_property->props[107].data.boolean.value = &file_moving;
     ...
     * General data:
     */
    gnet_property->props[108].name = "prefer_compressed_gnet";
    gnet_property->props[108].desc = "If active, only compressed incoming connections are allowed after the minimum number of connections has been established. Always allows for one non-compressed connection.";
    ...
    gnet_property->props[108].data.boolean.def   = &prefer_compressed_gnet_def;
    gnet_property->props[108].data.boolean.value = &prefer_compressed_gnet;
     ...
     * General data:
     */
    gnet_property->props[109].name = "online_mode";
    gnet_property->props[109].desc = "If deactivated only uploads and downloads will continue. All gNet connections are disabled/terminated.";
    ...
    gnet_property->props[109].data.boolean.def   = &online_mode_def;
    gnet_property->props[109].data.boolean.value = &online_mode;
     ...
     * General data:
     */
    gnet_property->props[110].name = "lib_debug";
    gnet_property->props[110].desc = "Debug level for code shared between gui and core";
    ...
    gnet_property->props[110].data.guint32.def   = &lib_debug_def;
    gnet_property->props[110].data.guint32.value = &lib_debug;
    ...
    gnet_property->props[111].data.boolean.def   = &download_require_urn_def;
    gnet_property->props[111].data.boolean.value = &download_require_urn;
     ...
     * General data:
     */
    gnet_property->props[112].name = "download_require_server_name";
    gnet_property->props[112].desc = "Whether gtk-gnutella should make sure the server gives us back a non-empty identifying token.";
    ...
    gnet_property->props[112].data.boolean.def   = &download_require_server_name_def;
    gnet_property->props[112].data.boolean.value = &download_require_server_name;
     ...
     * General data:
     */
    gnet_property->props[113].name = "force_ultrapeer";
    gnet_property->props[113].desc = "Whether gtk-gnutella should start up as an Ultrapeer regardless of whether the node is capable of handling it.  This setting is only valid for the first hour (debugging only).";
    ...
    gnet_property->props[113].data.boolean.def   = &force_ultrapeer_def;
    gnet_property->props[113].data.boolean.value = &force_ultrapeer;
     ...
     * General data:
     */
    gnet_property->props[114].name = "force_leaf";
    gnet_property->props[114].desc = "Whether gtk-gnutella should always act as a leaf node, regardless of whether the node is capable of becoming an Ultrapeer.";
    ...
    gnet_property->props[114].data.boolean.def   = &force_leaf_def;
    gnet_property->props[114].data.boolean.value = &force_leaf;
     ...
     * General data:
     */
    gnet_property->props[115].name = "max_ultrapeers";
    gnet_property->props[115].desc = "Maximum amount of Ultrapeers we should connect to as a leaf.";
    ...
    gnet_property->props[115].data.guint32.def   = &max_ultrapeers_def;
    gnet_property->props[115].data.guint32.value = &max_ultrapeers;
    gnet_property->props[115].data.guint32.max   = 4;
     ...
     * General data:
     */
    gnet_property->props[116].name = "max_leaves";
    gnet_property->props[116].desc = "Maximum amount of leaves we can accept.";
    ...
    gnet_property->props[116].data.guint32.def   = &max_leaves_def;
    gnet_property->props[116].data.guint32.value = &max_leaves;
    gnet_property->props[116].data.guint32.max   = 1000;
     ...
     * General data:
     */
    gnet_property->props[117].name = "enable_ultrapeer";
    gnet_property->props[117].desc = "Enable the ultrapeer features.";
    ...
    gnet_property->props[117].data.boolean.def   = &enable_ultrapeer_def;
    gnet_property->props[117].data.boolean.value = &enable_ultrapeer;
     ...
     * General data:
     */
    gnet_property->props[118].name = "current_peermode";
    gnet_property->props[118].desc = "Current peer mode for gtk-gnutella (acting as a Leaf / Ultra node).";
    ...
    gnet_property->props[118].data.guint32.def   = &current_peermode_def;
    gnet_property->props[118].data.guint32.value = &current_peermode;
