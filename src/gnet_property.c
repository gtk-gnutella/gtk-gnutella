...
prop_set_t *gnet_prop_init(void) {
     ...
     * General data:
     */
    gnet_property->props[116].name = "auto_feed_download_mesh";
    gnet_property->props[116].desc = _("Whether or not to automatically feed the download mesh with data gathered from the query hits that flow through our node. This looks for new entries for files we are sharing or already have in our mesh.");
    gnet_property->props[116].ev_changed = event_new("auto_feed_download_mesh_changed");
    gnet_property->props[116].save = TRUE;
    gnet_property->props[116].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[116].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[116].data.boolean.def   = &auto_feed_download_mesh_def;
    gnet_property->props[116].data.boolean.value = &auto_feed_download_mesh;
     ...
     * General data:
     */
    gnet_property->props[117].name = "strict_sha1_matching";
    gnet_property->props[117].desc = _("When enabled, SHA1s must match. Otherwise, name and size will be sufficient");
    gnet_property->props[117].ev_changed = event_new("strict_sha1_matching_changed");
    gnet_property->props[117].save = TRUE;
    gnet_property->props[117].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[117].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[117].data.boolean.def   = &strict_sha1_matching_def;
    gnet_property->props[117].data.boolean.value = &strict_sha1_matching;
     ...
     * General data:
     */
    gnet_property->props[118].name = "use_fuzzy_matching";
    gnet_property->props[118].desc = _("Use fuzzy file name matching (recommended = NO; only rely on SHA1 matching to be safe)");
    gnet_property->props[118].ev_changed = event_new("use_fuzzy_matching_changed");
    gnet_property->props[118].save = TRUE;
    gnet_property->props[118].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[118].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[118].data.boolean.def   = &use_fuzzy_matching_def;
    gnet_property->props[118].data.boolean.value = &use_fuzzy_matching;
     ...
     * General data:
     */
    gnet_property->props[119].name = "fuzzy_threshold";
    gnet_property->props[119].desc = _("Fuzziness threshold for filename matching (higher = stricter). A value of 100 means the filenames must be 100% identical.  A value of 0 means any two filenames will always be considered to be identical.  The minimum is 50%.");
    gnet_property->props[119].ev_changed = event_new("fuzzy_threshold_changed");
    gnet_property->props[119].save = TRUE;
    gnet_property->props[119].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[119].type               = PROP_TYPE_GUINT32;
    gnet_property->props[119].data.guint32.def   = &fuzzy_threshold_def;
    gnet_property->props[119].data.guint32.value = &fuzzy_threshold;
    gnet_property->props[119].data.guint32.choices = NULL;
    gnet_property->props[119].data.guint32.max   = 100;
     ...
     * General data:
     */
    gnet_property->props[120].name = "is_firewalled";
    gnet_property->props[120].desc = _("Whether gtk-gnutella thinks we're currently firewalled");
    gnet_property->props[120].ev_changed = event_new("is_firewalled_changed");
    gnet_property->props[120].save = TRUE;
    gnet_property->props[120].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[120].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[120].data.boolean.def   = &is_firewalled_def;
    gnet_property->props[120].data.boolean.value = &is_firewalled;
     ...
     * General data:
     */
    gnet_property->props[121].name = "is_inet_connected";
    gnet_property->props[121].desc = _("Whether gtk-gnutella thinks it's connected to the Internet");
    gnet_property->props[121].ev_changed = event_new("is_inet_connected_changed");
    gnet_property->props[121].save = FALSE;
    gnet_property->props[121].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[121].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[121].data.boolean.def   = &is_inet_connected_def;
    gnet_property->props[121].data.boolean.value = &is_inet_connected;
     ...
     * General data:
     */
    gnet_property->props[122].name = "gnet_compact_query";
    gnet_property->props[122].desc = _("Remove unnecessary ballast from query string before processing or forwarding them. Reduces traffic at the cost of little CPU time");
    gnet_property->props[122].ev_changed = event_new("gnet_compact_query_changed");
    gnet_property->props[122].save = TRUE;
    gnet_property->props[122].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[122].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[122].data.boolean.def   = &gnet_compact_query_def;
    gnet_property->props[122].data.boolean.value = &gnet_compact_query;
     ...
     * General data:
     */
    gnet_property->props[123].name = "download_optimistic_start";
    gnet_property->props[123].desc = _("Also use sources that don't provide a SHA1 value for the first chunk of a file. This dramatically reduces the 'No URN on server' messages, but may result in overlap problems later if the first chunk was actually from a different file. Use with caution.");
    gnet_property->props[123].ev_changed = event_new("download_optimistic_start_changed");
    gnet_property->props[123].save = TRUE;
    gnet_property->props[123].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[123].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[123].data.boolean.def   = &download_optimistic_start_def;
    gnet_property->props[123].data.boolean.value = &download_optimistic_start;
    ...
    gnet_property->props[134].desc = _("What to do with files that will be ignored for downloading.");
    gnet_property->props[134].ev_changed = event_new("search_handle_ignored_files_changed");
    ...
    gnet_property->props[134].data.guint32.choices = search_handle_ignored_files_choices;
    ...
    gnet_property->props[135].desc = _("The peer mode you want to operate as for gtk-gnutella.  When auto is selected, gtk-gnutella will start as a leaf node and may be promoted to an ultra node if bandwidth and uptime permits, provided that you are not firewalled.");
    ...
    gnet_property->props[136].data.guint32.def   = &current_peermode_def;
    gnet_property->props[136].data.guint32.value = &current_peermode;
    ...
    gnet_property->props[137].desc = _("How many file descriptors a process can open.");
    ...
    gnet_property->props[138].desc = _("How many KB of physical memory is available.");
    ...
    gnet_property->props[139].desc = _("How many downloads are currently held in the queue.");
    ...
    gnet_property->props[140].desc = _("How many downloads are currently running (downloading / connecting).");
    ...
    gnet_property->props[142].desc = _("How many downloads are currently actively queued.");
    ...
    gnet_property->props[143].desc = _("How many downloads are currently passively queued.");
     ...
     * General data:
     */
    gnet_property->props[144].name = "fi_all_count";
    gnet_property->props[144].desc = _("How many fileinfo do we have.");
    gnet_property->props[144].ev_changed = event_new("fi_all_count_changed");
    gnet_property->props[144].save = FALSE;
    gnet_property->props[144].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[144].type               = PROP_TYPE_GUINT32;
    gnet_property->props[144].data.guint32.def   = &fi_all_count_def;
    gnet_property->props[144].data.guint32.value = &fi_all_count;
     ...
     * General data:
     */
    gnet_property->props[145].name = "fi_with_source_count";
    gnet_property->props[145].desc = _("How many fileinfo with sources do we have.");
    gnet_property->props[145].ev_changed = event_new("fi_with_source_count_changed");
    gnet_property->props[145].save = FALSE;
    gnet_property->props[145].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[145].type               = PROP_TYPE_GUINT32;
    gnet_property->props[145].data.guint32.def   = &fi_with_source_count_def;
    gnet_property->props[145].data.guint32.value = &fi_with_source_count;
     ...
     * General data:
     */
    gnet_property->props[146].name = "dl_qalive_count";
    gnet_property->props[146].desc = _("How many queued downloads are currently responsive (remote servent answering requests).");
    gnet_property->props[146].ev_changed = event_new("dl_qalive_count_changed");
    gnet_property->props[146].save = FALSE;
    gnet_property->props[146].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[146].type               = PROP_TYPE_GUINT32;
    gnet_property->props[146].data.guint32.def   = &dl_qalive_count_def;
    gnet_property->props[146].data.guint32.value = &dl_qalive_count;
     ...
     * General data:
     */
    gnet_property->props[147].name = "dl_byte_count";
    gnet_property->props[147].desc = _("Amount of bytes downloaded so far, HTTP headers notwithstanding.");
    gnet_property->props[147].ev_changed = event_new("dl_byte_count_changed");
    gnet_property->props[147].save = FALSE;
    gnet_property->props[147].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[147].type               = PROP_TYPE_GUINT32;
    gnet_property->props[147].data.guint32.def   = &dl_byte_count_def;
    gnet_property->props[147].data.guint32.value = &dl_byte_count;
     ...
     * General data:
     */
    gnet_property->props[148].name = "ul_byte_count";
    gnet_property->props[148].desc = _("Amount of bytes uploaded so far, HTTP headers notwithstanding.");
    gnet_property->props[148].ev_changed = event_new("ul_byte_count_changed");
    gnet_property->props[148].save = FALSE;
    gnet_property->props[148].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[148].type               = PROP_TYPE_GUINT32;
    gnet_property->props[148].data.guint32.def   = &ul_byte_count_def;
    gnet_property->props[148].data.guint32.value = &ul_byte_count;
     ...
     * General data:
     */
    gnet_property->props[149].name = "pfsp_server";
    gnet_property->props[149].desc = _("Whether gtk-gnutella should serve partial files whilst they are still incompletely downloaded.  Recommended for network's health unless you already share many files, in which case it does no harm to leave it in, but will not matter as much.");
    gnet_property->props[149].ev_changed = event_new("pfsp_server_changed");
    gnet_property->props[149].save = TRUE;
    gnet_property->props[149].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[149].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[149].data.boolean.def   = &pfsp_server_def;
    gnet_property->props[149].data.boolean.value = &pfsp_server;
     ...
     * General data:
     */
    gnet_property->props[152].name = "crawler_visit_count";
    gnet_property->props[152].desc = _("Number of crawler visits during this session");
    gnet_property->props[152].ev_changed = event_new("crawler_visit_count_changed");
    gnet_property->props[152].save = FALSE;
    gnet_property->props[152].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[152].type               = PROP_TYPE_GUINT32;
    gnet_property->props[152].data.guint32.def   = &crawler_visit_count_def;
    gnet_property->props[152].data.guint32.value = &crawler_visit_count;
     ...
     * General data:
     */
    gnet_property->props[153].name = "host_runs_ntp";
    gnet_property->props[153].desc = _("Whether the clock of this host is kept accurate via NTP. When you enable this, the computed clock skew is ignored.");
    gnet_property->props[153].ev_changed = event_new("host_runs_ntp_changed");
    gnet_property->props[153].save = TRUE;
    gnet_property->props[153].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[153].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[153].data.boolean.def   = &host_runs_ntp_def;
    gnet_property->props[153].data.boolean.value = &host_runs_ntp;
     ...
     * General data:
     */
    gnet_property->props[154].name = "clock_skew";
    gnet_property->props[154].desc = _("The signed clock skew of this host compared to absolute time. Adding this skew to the host clock should give the true time.");
    gnet_property->props[154].ev_changed = event_new("clock_skew_changed");
    gnet_property->props[154].save = TRUE;
    gnet_property->props[154].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[154].type               = PROP_TYPE_GUINT32;
    gnet_property->props[154].data.guint32.def   = &clock_skew_def;
    gnet_property->props[154].data.guint32.value = &clock_skew;
     ...
     * General data:
     */
    gnet_property->props[155].name = "node_monitor_unstable_ip";
    gnet_property->props[155].desc = _("Whether gtk-gnutella should keep track of the IP of unstable servents it encounters, preventing further connections attempts to/from them.");
    gnet_property->props[155].ev_changed = event_new("node_monitor_unstable_ip_changed");
    gnet_property->props[155].save = TRUE;
    gnet_property->props[155].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[155].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[155].data.boolean.def   = &node_monitor_unstable_ip_def;
    gnet_property->props[155].data.boolean.value = &node_monitor_unstable_ip;
     ...
     * General data:
     */
    gnet_property->props[156].name = "node_monitor_unstable_servents";
    gnet_property->props[156].desc = _("Whether gtk-gnutella should determine the servent types (as identified by their vendor string) that are unstable, preventing further connections to/from them.  This only works when gtk-gnutella already keeps track of unstable IP addresses.");
    gnet_property->props[156].ev_changed = event_new("node_monitor_unstable_servents_changed");
    gnet_property->props[156].save = TRUE;
    gnet_property->props[156].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[156].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[156].data.boolean.def   = &node_monitor_unstable_servents_def;
    gnet_property->props[156].data.boolean.value = &node_monitor_unstable_servents;
