...
prop_set_t *gnet_prop_init(void) {
     ...
     * General data:
     */
    gnet_property->props[203].name = "file_descriptor_shortage";
    gnet_property->props[203].desc = _("When set, gtk-gnutella is running short on file descriptors, but normal operations are still possible. The condition automatically clears itself after 10 minutes without any more shortage.");
    gnet_property->props[203].ev_changed = event_new("file_descriptor_shortage_changed");
    gnet_property->props[203].save = FALSE;
    gnet_property->props[203].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[203].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[203].data.boolean.def   = &file_descriptor_shortage_def;
    gnet_property->props[203].data.boolean.value = &file_descriptor_shortage;
     ...
     * General data:
     */
    gnet_property->props[204].name = "file_descriptor_runout";
    gnet_property->props[204].desc = _("When set, gtk-gnutella has running out of file descriptors, and operations are necessarily degraded, if not impossible. The condition automatically clears itself after 10 minutes past the last occurance.");
    gnet_property->props[204].ev_changed = event_new("file_descriptor_runout_changed");
    gnet_property->props[204].save = FALSE;
    gnet_property->props[204].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[204].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[204].data.boolean.def   = &file_descriptor_runout_def;
    gnet_property->props[204].data.boolean.value = &file_descriptor_runout;
