...
prop_set_t *gnet_prop_init(void) {
    ...
    gnet_property->props[130].desc = _("Maximum amount of Ultrapeers we should connect to as a leaf.");
    ...
    gnet_property->props[131].desc = _("Maximum amount of leaves we can accept.");
     ...
     * General data:
     */
    gnet_property->props[132].name = "configured_peermode";
    gnet_property->props[132].desc = _("The peer mode you want to operate as for gtk-gnutella.  When auto is selected, gtk-gnutella will start as a leaf node and may be promoted to an ultra node if bandwidth and uptime permits, provided that you are not firewalled.");
    gnet_property->props[132].ev_changed = event_new("configured_peermode_changed");
    gnet_property->props[132].save = TRUE;
    gnet_property->props[132].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[132].type               = PROP_TYPE_MULTICHOICE;
    gnet_property->props[132].data.guint32.def   = &configured_peermode_def;
    gnet_property->props[132].data.guint32.value = &configured_peermode;
    gnet_property->props[132].data.guint32.max   = 0xFFFFFFFF;
    gnet_property->props[132].data.guint32.min   = 0x00000000;
    gnet_property->props[132].data.guint32.choices = configured_peermode_choices;
    ...
    gnet_property->props[133].desc = _("Current peer mode for gtk-gnutella");
    ...
    gnet_property->props[134].desc = _("How many file descriptors a process can open.");
    ...
    gnet_property->props[135].desc = _("How many KB of physical memory is available.");
    ...
    gnet_property->props[136].desc = _("How many downloads are currently held in the queue.");
    ...
    gnet_property->props[137].desc = _("How many downloads are currently running (downloading / connecting).");
    ...
    gnet_property->props[138].desc = _("How many downloads are currently active.");
    ...
    gnet_property->props[139].desc = _("How many queued downloads are currently responsive (remote servent answering requests).");
    ...
    gnet_property->props[140].desc = _("Amount of bytes downloaded so far, HTTP headers notwithstanding.");
    ...
    gnet_property->props[141].desc = _("Amount of bytes uploaded so far, HTTP headers notwithstanding.");
    ...
    gnet_property->props[142].desc = _("Whether gtk-gnutella should serve partial files whilst they are still incompletely downloaded.  Recommended for network's health unless you already share many files, in which case it does no harm to leave it in, but will not matter as much.");
    ...
    gnet_property->props[145].desc = _("Number of crawler visits during this session");
