/*
 * Generated on Mon May 21 12:38:30 2018 by enum-msg.pl -- DO NOT EDIT
 *
...
static const char *stats_symbols[] = {
	...
	"udp_sr_tx_msg_reliable_1_frag",
	"udp_sr_tx_msg_reliable_2_frags",
	"udp_sr_tx_msg_reliable_3_frags",
	"udp_sr_tx_msg_reliable_4_frags",
	"udp_sr_tx_msg_reliable_5_frags",
	"udp_sr_tx_msg_reliable_6plus_frags",
...
static const char *stats_text[] = {
	...
	N_("Semi-reliable UDP reliable TX with 1 fragment"),
	N_("Semi-reliable UDP reliable TX with 2 fragments"),
	N_("Semi-reliable UDP reliable TX with 3 fragments"),
	N_("Semi-reliable UDP reliable TX with 4 fragments"),
	N_("Semi-reliable UDP reliable TX with 5 fragments"),
	N_("Semi-reliable UDP reliable TX with 6+ fragments"),
