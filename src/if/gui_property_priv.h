...
extern const guint32  nodes_col_widths[7];
extern const gboolean nodes_col_visible[7];
extern const guint32  dl_active_col_widths[7];
extern const gboolean dl_active_col_visible[7];
extern const guint32  dl_queued_col_widths[5];
extern const gboolean dl_queued_col_visible[5];
...
extern const guint32  uploads_col_widths[7];
