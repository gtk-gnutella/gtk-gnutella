...
prop_set_t *gui_prop_init(void) {
     ...
     * General data:
     */
    gui_property->props[63].name = "search_stats_mode";
    gui_property->props[63].desc = _("Collect statistics about searches that go through this node.");
    gui_property->props[63].ev_changed = event_new("search_stats_mode_changed");
    gui_property->props[63].save = TRUE;
    gui_property->props[63].vector_size = 1;

    /* Type specific data: */
    gui_property->props[63].type               = PROP_TYPE_MULTICHOICE;
    gui_property->props[63].data.guint32.def   = &search_stats_mode_def;
    gui_property->props[63].data.guint32.value = &search_stats_mode;
    gui_property->props[63].data.guint32.max   = 0xFFFFFFFF;
    gui_property->props[63].data.guint32.min   = 0x00000000;
    gui_property->props[63].data.guint32.choices = search_stats_mode_choices;
     ...
     * General data:
     */
    gui_property->props[64].name = "search_stats_update_interval";
    gui_property->props[64].desc = _("Interval in which the search stats are updated.");
    gui_property->props[64].ev_changed = event_new("search_stats_update_interval_changed");
    gui_property->props[64].save = TRUE;
    gui_property->props[64].vector_size = 1;

    /* Type specific data: */
    gui_property->props[64].type               = PROP_TYPE_GUINT32;
    gui_property->props[64].data.guint32.def   = &search_stats_update_interval_def;
    gui_property->props[64].data.guint32.value = &search_stats_update_interval;
    gui_property->props[64].data.guint32.choices = NULL;
    gui_property->props[64].data.guint32.max   = 50000;
     ...
     * General data:
     */
    gui_property->props[65].name = "search_stats_delcoef";
    gui_property->props[65].desc = _("A deletion coefficient, so that small non-significant results can be dropped.  The lower it is, the more search statistics will be kept in memory.");
    gui_property->props[65].ev_changed = event_new("search_stats_delcoef_changed");
    gui_property->props[65].save = TRUE;
    gui_property->props[65].vector_size = 1;

    /* Type specific data: */
    gui_property->props[65].type               = PROP_TYPE_GUINT32;
    gui_property->props[65].data.guint32.def   = &search_stats_delcoef_def;
    gui_property->props[65].data.guint32.value = &search_stats_delcoef;
    gui_property->props[65].data.guint32.choices = NULL;
    gui_property->props[65].data.guint32.max   = 100;
     ...
     * General data:
     */
    gui_property->props[66].name = "confirm_quit";
    gui_property->props[66].desc = _("Show confirmation dialog when leaving gtk-gnutella.");
    gui_property->props[66].ev_changed = event_new("confirm_quit_changed");
    gui_property->props[66].save = TRUE;
    gui_property->props[66].vector_size = 1;

    /* Type specific data: */
    gui_property->props[66].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[66].data.boolean.def   = &confirm_quit_def;
    gui_property->props[66].data.boolean.value = &confirm_quit;
     ...
     * General data:
     */
    gui_property->props[67].name = "show_tooltips";
    gui_property->props[67].desc = _("Show a helpful message when the mouse pointer lingers over a widget.");
    gui_property->props[67].ev_changed = event_new("show_tooltips_changed");
    gui_property->props[67].save = TRUE;
    gui_property->props[67].vector_size = 1;

    /* Type specific data: */
    gui_property->props[67].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[67].data.boolean.def   = &show_tooltips_def;
    gui_property->props[67].data.boolean.value = &show_tooltips;
     ...
     * General data:
     */
    gui_property->props[68].name = "expert_mode";
    gui_property->props[68].desc = _("Show a lot more settings to tweak. If you tamper with them be sure to read up on what they are doing.");
    gui_property->props[68].ev_changed = event_new("expert_mode_changed");
    gui_property->props[68].save = TRUE;
    gui_property->props[68].vector_size = 1;

    /* Type specific data: */
    gui_property->props[68].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[68].data.boolean.def   = &expert_mode_def;
    gui_property->props[68].data.boolean.value = &expert_mode;
     ...
     * General data:
     */
    gui_property->props[69].name = "gnet_stats_perc";
    gui_property->props[69].desc = _("Show percentages instead of absolute values in the Gnet stats.");
    gui_property->props[69].ev_changed = event_new("gnet_stats_perc_changed");
    gui_property->props[69].save = TRUE;
    gui_property->props[69].vector_size = 1;

    /* Type specific data: */
    gui_property->props[69].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[69].data.boolean.def   = &gnet_stats_perc_def;
    gui_property->props[69].data.boolean.value = &gnet_stats_perc;
     ...
     * General data:
     */
    gui_property->props[70].name = "gnet_stats_bytes";
    gui_property->props[70].desc = _("Show bytes instead of packets in the Gnet stats.");
    gui_property->props[70].ev_changed = event_new("gnet_stats_bytes_changed");
    gui_property->props[70].save = TRUE;
    gui_property->props[70].vector_size = 1;

    /* Type specific data: */
    gui_property->props[70].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[70].data.boolean.def   = &gnet_stats_bytes_def;
    gui_property->props[70].data.boolean.value = &gnet_stats_bytes;
     ...
     * General data:
     */
    gui_property->props[71].name = "gnet_stats_hops";
    gui_property->props[71].desc = _("Show stats per hops instead of per TTL.");
    gui_property->props[71].ev_changed = event_new("gnet_stats_hops_changed");
    gui_property->props[71].save = TRUE;
    gui_property->props[71].vector_size = 1;

    /* Type specific data: */
    gui_property->props[71].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[71].data.boolean.def   = &gnet_stats_hops_def;
    gui_property->props[71].data.boolean.value = &gnet_stats_hops;
     ...
     * General data:
     */
    gui_property->props[72].name = "gnet_stats_source";
    gui_property->props[72].desc = _("Choose source of stats to be displayed.");
    gui_property->props[72].ev_changed = event_new("gnet_stats_source_changed");
    gui_property->props[72].save = TRUE;
    gui_property->props[72].vector_size = 1;

    /* Type specific data: */
    gui_property->props[72].type               = PROP_TYPE_MULTICHOICE;
    gui_property->props[72].data.guint32.def   = &gnet_stats_source_def;
    gui_property->props[72].data.guint32.value = &gnet_stats_source;
    gui_property->props[72].data.guint32.max   = 0xFFFFFFFF;
    gui_property->props[72].data.guint32.min   = 0x00000000;
    gui_property->props[72].data.guint32.choices = gnet_stats_source_choices;
    ...
    gui_property->props[73].data.boolean.def   = &gnet_stats_with_headers_def;
    gui_property->props[73].data.boolean.value = &gnet_stats_with_headers;
    ...
    gui_property->props[74].data.boolean.def   = &gnet_stats_drop_perc_def;
    gui_property->props[74].data.boolean.value = &gnet_stats_drop_perc;
    ...
    gui_property->props[75].data.guint32.def   = gnet_stats_general_col_widths_def;
    gui_property->props[75].data.guint32.value = gnet_stats_general_col_widths;
    ...
    gui_property->props[76].data.boolean.def   = &clear_uploads_complete_def;
    gui_property->props[76].data.boolean.value = &clear_uploads_complete;
    ...
    gui_property->props[77].data.boolean.def   = &clear_uploads_failed_def;
    gui_property->props[77].data.boolean.value = &clear_uploads_failed;
    ...
    gui_property->props[78].data.boolean.def   = &node_show_uptime_def;
    gui_property->props[78].data.boolean.value = &node_show_uptime;
    ...
    gui_property->props[79].data.boolean.def   = &node_show_handshake_version_def;
    gui_property->props[79].data.boolean.value = &node_show_handshake_version;
    ...
    gui_property->props[80].data.boolean.def   = &node_show_detailed_info_def;
    gui_property->props[80].data.boolean.value = &node_show_detailed_info;
    ...
    gui_property->props[81].data.boolean.def   = &show_gnet_info_txc_def;
    gui_property->props[81].data.boolean.value = &show_gnet_info_txc;
    ...
    gui_property->props[82].data.boolean.def   = &show_gnet_info_rxc_def;
    gui_property->props[82].data.boolean.value = &show_gnet_info_rxc;
    ...
    gui_property->props[83].data.boolean.def   = &show_gnet_info_tx_wire_def;
    gui_property->props[83].data.boolean.value = &show_gnet_info_tx_wire;
    ...
    gui_property->props[84].data.boolean.def   = &show_gnet_info_rx_wire_def;
    gui_property->props[84].data.boolean.value = &show_gnet_info_rx_wire;
