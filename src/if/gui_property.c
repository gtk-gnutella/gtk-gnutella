...
gui_prop_init(void) {
     ...
     * General data:
     */
    gui_property->props[60].name = "show_search_results_settings";
    gui_property->props[60].desc = _("Display search settings.");
    gui_property->props[60].ev_changed = event_new("show_search_results_settings_changed");
    gui_property->props[60].save = TRUE;
    gui_property->props[60].vector_size = 1;

    /* Type specific data: */
    gui_property->props[60].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[60].data.boolean.def   = &show_search_results_settings_def;
    gui_property->props[60].data.boolean.value = &show_search_results_settings;
     ...
     * General data:
     */
    gui_property->props[61].name = "show_dl_settings";
    gui_property->props[61].desc = _("Display download settings.");
    gui_property->props[61].ev_changed = event_new("show_dl_settings_changed");
    gui_property->props[61].save = TRUE;
    gui_property->props[61].vector_size = 1;

    /* Type specific data: */
    gui_property->props[61].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[61].data.boolean.def   = &show_dl_settings_def;
    gui_property->props[61].data.boolean.value = &show_dl_settings;
    ...
    gui_property->props[71].data.guint32.def   = &gnet_stats_source_def;
    gui_property->props[71].data.guint32.value = &gnet_stats_source;
    gui_property->props[71].data.guint32.max   = 0xFFFFFFFF;
    gui_property->props[71].data.guint32.min   = 0x00000000;
    gui_property->props[71].data.guint32.choices = gnet_stats_source_choices;
     ...
     * General data:
     */
    gui_property->props[72].name = "gnet_stats_with_headers";
    gui_property->props[72].desc = _("Include Gnutella packet header size to the volume.");
    gui_property->props[72].ev_changed = event_new("gnet_stats_with_headers_changed");
    gui_property->props[72].save = TRUE;
    gui_property->props[72].vector_size = 1;

    /* Type specific data: */
    gui_property->props[72].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[72].data.boolean.def   = &gnet_stats_with_headers_def;
    gui_property->props[72].data.boolean.value = &gnet_stats_with_headers;
     ...
     * General data:
     */
    gui_property->props[73].name = "gnet_stats_drop_perc";
    gui_property->props[73].desc = _("Show percentages instead of absolute values in the Gnet stats (drop reasons).");
    gui_property->props[73].ev_changed = event_new("gnet_stats_drop_perc_changed");
    gui_property->props[73].save = TRUE;
    gui_property->props[73].vector_size = 1;

    /* Type specific data: */
    gui_property->props[73].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[73].data.boolean.def   = &gnet_stats_drop_perc_def;
    gui_property->props[73].data.boolean.value = &gnet_stats_drop_perc;
     ...
     * General data:
     */
    gui_property->props[74].name = "widths_gnet_stats_general";
    gui_property->props[74].desc = _("Widths of the columns in the Gnet stats general table.");
    gui_property->props[74].ev_changed = event_new("gnet_stats_general_col_widths_changed");
    gui_property->props[74].save = TRUE;
    gui_property->props[74].vector_size = 2;

    /* Type specific data: */
    gui_property->props[74].type               = PROP_TYPE_GUINT32;
    gui_property->props[74].data.guint32.def   = gnet_stats_general_col_widths_def;
    gui_property->props[74].data.guint32.value = gnet_stats_general_col_widths;
     ...
     * General data:
     */
    gui_property->props[75].name = "auto_clear_completed_uploads";
    gui_property->props[75].desc = _("Auto clear completed uploads.");
    gui_property->props[75].ev_changed = event_new("autoclear_completed_uploads_changed");
    gui_property->props[75].save = TRUE;
    gui_property->props[75].vector_size = 1;

    /* Type specific data: */
    gui_property->props[75].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[75].data.boolean.def   = &clear_uploads_complete_def;
    gui_property->props[75].data.boolean.value = &clear_uploads_complete;
     ...
     * General data:
     */
    gui_property->props[76].name = "auto_clear_failed_uploads";
    gui_property->props[76].desc = _("Auto clear failed uploads.");
    gui_property->props[76].ev_changed = event_new("autoclear_failed_uploads_changed");
    gui_property->props[76].save = TRUE;
    gui_property->props[76].vector_size = 1;

    /* Type specific data: */
    gui_property->props[76].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[76].data.boolean.def   = &clear_uploads_failed_def;
    gui_property->props[76].data.boolean.value = &clear_uploads_failed;
     ...
     * General data:
     */
    gui_property->props[77].name = "node_show_uptime";
    gui_property->props[77].desc = _("Whether the node's uptime should be shown (not all nodes provide this information).");
    gui_property->props[77].ev_changed = event_new("node_show_uptime_changed");
    gui_property->props[77].save = TRUE;
    gui_property->props[77].vector_size = 1;

    /* Type specific data: */
    gui_property->props[77].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[77].data.boolean.def   = &node_show_uptime_def;
    gui_property->props[77].data.boolean.value = &node_show_uptime;
     ...
     * General data:
     */
    gui_property->props[78].name = "node_show_handshake_version";
    gui_property->props[78].desc = _("Whether the handshaking version number should be displayed.");
    gui_property->props[78].ev_changed = event_new("node_show_handshake_version_changed");
    gui_property->props[78].save = TRUE;
    gui_property->props[78].vector_size = 1;

    /* Type specific data: */
    gui_property->props[78].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[78].data.boolean.def   = &node_show_handshake_version_def;
    gui_property->props[78].data.boolean.value = &node_show_handshake_version;
     ...
     * General data:
     */
    gui_property->props[79].name = "node_show_detailed_info";
    gui_property->props[79].desc = _("Whether detailed traffic information should be shown for the node.  When enabled, it is possible to also customize how much information to display.  When disabled, only TX and RX message counts are displayed, followed by the message queue info.");
    gui_property->props[79].ev_changed = event_new("node_show_detailed_info_changed");
    gui_property->props[79].save = TRUE;
    gui_property->props[79].vector_size = 1;

    /* Type specific data: */
    gui_property->props[79].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[79].data.boolean.def   = &node_show_detailed_info_def;
    gui_property->props[79].data.boolean.value = &node_show_detailed_info;
     ...
     * General data:
     */
    gui_property->props[80].name = "show_gnet_info_txc";
    gui_property->props[80].desc = _("Whether TX traffic compression ratio should be displayed.");
    gui_property->props[80].ev_changed = event_new("show_gnet_info_txc_changed");
    gui_property->props[80].save = TRUE;
    gui_property->props[80].vector_size = 1;

    /* Type specific data: */
    gui_property->props[80].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[80].data.boolean.def   = &show_gnet_info_txc_def;
    gui_property->props[80].data.boolean.value = &show_gnet_info_txc;
     ...
     * General data:
     */
    gui_property->props[81].name = "show_gnet_info_rxc";
    gui_property->props[81].desc = _("Whether RX traffic compression ratio should be displayed.");
    gui_property->props[81].ev_changed = event_new("show_gnet_info_rxc_changed");
    gui_property->props[81].save = TRUE;
    gui_property->props[81].vector_size = 1;

    /* Type specific data: */
    gui_property->props[81].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[81].data.boolean.def   = &show_gnet_info_rxc_def;
    gui_property->props[81].data.boolean.value = &show_gnet_info_rxc;
     ...
     * General data:
     */
    gui_property->props[82].name = "show_gnet_info_tx_wire";
    gui_property->props[82].desc = _("Whether to display the amount of bytes sent on the TX wire.");
    gui_property->props[82].ev_changed = event_new("show_gnet_info_tx_wire_changed");
    gui_property->props[82].save = TRUE;
    gui_property->props[82].vector_size = 1;

    /* Type specific data: */
    gui_property->props[82].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[82].data.boolean.def   = &show_gnet_info_tx_wire_def;
    gui_property->props[82].data.boolean.value = &show_gnet_info_tx_wire;
     ...
     * General data:
     */
    gui_property->props[83].name = "show_gnet_info_rx_wire";
    gui_property->props[83].desc = _("Whether to display the amount of bytes received on the RX wire.");
    gui_property->props[83].ev_changed = event_new("show_gnet_info_rx_wire_changed");
    gui_property->props[83].save = TRUE;
    gui_property->props[83].vector_size = 1;

    /* Type specific data: */
    gui_property->props[83].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[83].data.boolean.def   = &show_gnet_info_rx_wire_def;
    gui_property->props[83].data.boolean.value = &show_gnet_info_rx_wire;
     ...
     * General data:
     */
    gui_property->props[84].name = "show_gnet_info_tx_speed";
    gui_property->props[84].desc = _("Whether TX instantaneous transmission speed should be displayed.");
    gui_property->props[84].ev_changed = event_new("show_gnet_info_tx_speed_changed");
    gui_property->props[84].save = TRUE;
    gui_property->props[84].vector_size = 1;

    /* Type specific data: */
    gui_property->props[84].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[84].data.boolean.def   = &show_gnet_info_tx_speed_def;
    gui_property->props[84].data.boolean.value = &show_gnet_info_tx_speed;
     ...
     * General data:
     */
    gui_property->props[85].name = "show_gnet_info_rx_speed";
    gui_property->props[85].desc = _("Whether RX instantaneous transmission speed should be displayed.");
    gui_property->props[85].ev_changed = event_new("show_gnet_info_rx_speed_changed");
    gui_property->props[85].save = TRUE;
    gui_property->props[85].vector_size = 1;

    /* Type specific data: */
    gui_property->props[85].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[85].data.boolean.def   = &show_gnet_info_rx_speed_def;
    gui_property->props[85].data.boolean.value = &show_gnet_info_rx_speed;
     ...
     * General data:
     */
    gui_property->props[86].name = "show_gnet_info_tx_queries";
    gui_property->props[86].desc = _("Whether count of transmitted queries should be displayed.");
    gui_property->props[86].ev_changed = event_new("show_gnet_info_tx_queries_changed");
    gui_property->props[86].save = TRUE;
    gui_property->props[86].vector_size = 1;

    /* Type specific data: */
    gui_property->props[86].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[86].data.boolean.def   = &show_gnet_info_tx_queries_def;
    gui_property->props[86].data.boolean.value = &show_gnet_info_tx_queries;
     ...
     * General data:
     */
    gui_property->props[87].name = "show_gnet_info_rx_queries";
    gui_property->props[87].desc = _("Whether count of received queries should be displayed.");
    gui_property->props[87].ev_changed = event_new("show_gnet_info_rx_queries_changed");
    gui_property->props[87].save = TRUE;
    gui_property->props[87].vector_size = 1;

    /* Type specific data: */
    gui_property->props[87].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[87].data.boolean.def   = &show_gnet_info_rx_queries_def;
    gui_property->props[87].data.boolean.value = &show_gnet_info_rx_queries;
     ...
     * General data:
     */
    gui_property->props[88].name = "show_gnet_info_tx_hits";
    gui_property->props[88].desc = _("Whether count of transmitted query hits should be displayed.");
    gui_property->props[88].ev_changed = event_new("show_gnet_info_tx_hits_changed");
    gui_property->props[88].save = TRUE;
    gui_property->props[88].vector_size = 1;

    /* Type specific data: */
    gui_property->props[88].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[88].data.boolean.def   = &show_gnet_info_tx_hits_def;
    gui_property->props[88].data.boolean.value = &show_gnet_info_tx_hits;
     ...
     * General data:
     */
    gui_property->props[89].name = "show_gnet_info_rx_hits";
    gui_property->props[89].desc = _("Whether count of received query hits should be displayed.");
    gui_property->props[89].ev_changed = event_new("show_gnet_info_rx_hits_changed");
    gui_property->props[89].save = TRUE;
    gui_property->props[89].vector_size = 1;

    /* Type specific data: */
    gui_property->props[89].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[89].data.boolean.def   = &show_gnet_info_rx_hits_def;
    gui_property->props[89].data.boolean.value = &show_gnet_info_rx_hits;
     ...
     * General data:
     */
    gui_property->props[90].name = "show_gnet_info_gen_queries";
    gui_property->props[90].desc = _("Whether count of locally generated queries should be displayed.");
    gui_property->props[90].ev_changed = event_new("show_gnet_info_gen_queries_changed");
    gui_property->props[90].save = TRUE;
    gui_property->props[90].vector_size = 1;

    /* Type specific data: */
    gui_property->props[90].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[90].data.boolean.def   = &show_gnet_info_gen_queries_def;
    gui_property->props[90].data.boolean.value = &show_gnet_info_gen_queries;
     ...
     * General data:
     */
    gui_property->props[91].name = "show_gnet_info_sq_queries";
    gui_property->props[91].desc = _("Whether count of local queries pending transmission should be displayed.");
    gui_property->props[91].ev_changed = event_new("show_gnet_info_sq_queries_changed");
    gui_property->props[91].save = TRUE;
    gui_property->props[91].vector_size = 1;

    /* Type specific data: */
    gui_property->props[91].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[91].data.boolean.def   = &show_gnet_info_sq_queries_def;
    gui_property->props[91].data.boolean.value = &show_gnet_info_sq_queries;
     ...
     * General data:
     */
    gui_property->props[92].name = "show_gnet_info_tx_dropped";
    gui_property->props[92].desc = _("Whether count of dropped messages on TX should be displayed.");
    gui_property->props[92].ev_changed = event_new("show_gnet_info_tx_dropped_changed");
    gui_property->props[92].save = TRUE;
    gui_property->props[92].vector_size = 1;

    /* Type specific data: */
    gui_property->props[92].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[92].data.boolean.def   = &show_gnet_info_tx_dropped_def;
    gui_property->props[92].data.boolean.value = &show_gnet_info_tx_dropped;
     ...
     * General data:
     */
    gui_property->props[93].name = "show_gnet_info_rx_dropped";
    gui_property->props[93].desc = _("Whether count of dropped messages on RX should be displayed.");
    gui_property->props[93].ev_changed = event_new("show_gnet_info_rx_dropped_changed");
    gui_property->props[93].save = TRUE;
    gui_property->props[93].vector_size = 1;

    /* Type specific data: */
    gui_property->props[93].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[93].data.boolean.def   = &show_gnet_info_rx_dropped_def;
    gui_property->props[93].data.boolean.value = &show_gnet_info_rx_dropped;
     ...
     * General data:
     */
    gui_property->props[95].name = "show_gnet_info_dbw";
    gui_property->props[95].desc = _("Whether we should display message counts for duplicate, bad, weird and messages bearing an hostile IP address.");
    gui_property->props[95].ev_changed = event_new("show_gnet_info_dbw_changed");
    gui_property->props[95].save = TRUE;
    gui_property->props[95].vector_size = 1;

    /* Type specific data: */
    gui_property->props[95].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[95].data.boolean.def   = &show_gnet_info_dbw_def;
    gui_property->props[95].data.boolean.value = &show_gnet_info_dbw;
     ...
     * General data:
     */
    gui_property->props[96].name = "show_gnet_info_rt";
    gui_property->props[96].desc = _("Whether ping/pong roundtrip times (average and last) should be displayed.  Values shown are in milliseconds.");
    gui_property->props[96].ev_changed = event_new("show_gnet_info_rt_changed");
    gui_property->props[96].save = TRUE;
    gui_property->props[96].vector_size = 1;

    /* Type specific data: */
    gui_property->props[96].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[96].data.boolean.def   = &show_gnet_info_rt_def;
    gui_property->props[96].data.boolean.value = &show_gnet_info_rt;
     ...
     * General data:
     */
    gui_property->props[97].name = "show_gnet_info_shared_size";
    gui_property->props[97].desc = _("Whether we should display the size of the node's library, when it is known to us.");
    gui_property->props[97].ev_changed = event_new("show_gnet_info_shared_size_changed");
    gui_property->props[97].save = TRUE;
    gui_property->props[97].vector_size = 1;

    /* Type specific data: */
    gui_property->props[97].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[97].data.boolean.def   = &show_gnet_info_shared_size_def;
    gui_property->props[97].data.boolean.value = &show_gnet_info_shared_size;
     ...
     * General data:
     */
    gui_property->props[98].name = "show_gnet_info_shared_files";
    gui_property->props[98].desc = _("Whether we should display the amount of files shared by nodes, when that is known to us.");
    gui_property->props[98].ev_changed = event_new("show_gnet_info_shared_files_changed");
    gui_property->props[98].save = TRUE;
    gui_property->props[98].vector_size = 1;

    /* Type specific data: */
    gui_property->props[98].type               = PROP_TYPE_BOOLEAN;
    gui_property->props[98].data.boolean.def   = &show_gnet_info_shared_files_def;
    gui_property->props[98].data.boolean.value = &show_gnet_info_shared_files;
     ...
     * General data:
     */
    gui_property->props[99].name = "search_accumulation_period";
    gui_property->props[99].desc = _("The amount of time in seconds that the GUI should buffer search results as they come in.  This prevents too frequent updates that may cause flickering, but also saves CPU cycles since less redrawing has to occur in the search pane.");
    gui_property->props[99].ev_changed = event_new("search_accumulation_period_changed");
    gui_property->props[99].save = TRUE;
    gui_property->props[99].vector_size = 1;

    /* Type specific data: */
    gui_property->props[99].type               = PROP_TYPE_GUINT32;
    gui_property->props[99].data.guint32.def   = &search_accumulation_period_def;
    gui_property->props[99].data.guint32.value = &search_accumulation_period;
    gui_property->props[99].data.guint32.choices = NULL;
    gui_property->props[99].data.guint32.max   = 30;
    gui_property->props[99].data.guint32.min   = 1;
     ...
     * General data:
     */
    gui_property->props[100].name = "treemenu_nodes_expanded";
    gui_property->props[100].desc = _("Expanded stati of the nodes in the treemenu.");
    gui_property->props[100].ev_changed = event_new("treemenu_nodes_expanded_changed");
    gui_property->props[100].save = TRUE;
    gui_property->props[100].vector_size = nb_main_page_num;

    /* Type specific data: */
    gui_property->props[100].type               = PROP_TYPE_GUINT32;
    gui_property->props[100].data.guint32.def   = treemenu_nodes_expanded_def;
    gui_property->props[100].data.guint32.value = treemenu_nodes_expanded;
     ...
     * General data:
     */
    gui_property->props[101].name = "widths_gnet_stats_pkg";
    gui_property->props[101].desc = _("Widths of the columns in the Gnet packet stats table (pkg). [GTK2]");
    gui_property->props[101].ev_changed = event_new("gnet_stats_pkg_col_widths_changed");
    gui_property->props[101].save = TRUE;
    gui_property->props[101].vector_size = 6;

    /* Type specific data: */
    gui_property->props[101].type               = PROP_TYPE_GUINT32;
    gui_property->props[101].data.guint32.def   = gnet_stats_pkg_col_widths_def;
    gui_property->props[101].data.guint32.value = gnet_stats_pkg_col_widths;
     ...
     * General data:
     */
    gui_property->props[102].name = "widths_gnet_stats_byte";
    gui_property->props[102].desc = _("Widths of the columns in the Gnet packet stats table (byte). [GTK2]");
    gui_property->props[102].ev_changed = event_new("gnet_stats_byte_col_widths_changed");
    gui_property->props[102].save = TRUE;
    gui_property->props[102].vector_size = 6;

    /* Type specific data: */
    gui_property->props[102].type               = PROP_TYPE_GUINT32;
    gui_property->props[102].data.guint32.def   = gnet_stats_byte_col_widths_def;
    gui_property->props[102].data.guint32.value = gnet_stats_byte_col_widths;
     ...
     * General data:
     */
    gui_property->props[103].name = "config_toolbar_style";
    gui_property->props[103].desc = _("Configures the appearance of the toolbar.");
    gui_property->props[103].ev_changed = event_new("config_toolbar_style_changed");
    gui_property->props[103].save = TRUE;
    gui_property->props[103].vector_size = 1;

    /* Type specific data: */
    gui_property->props[103].type               = PROP_TYPE_MULTICHOICE;
    gui_property->props[103].data.guint32.def   = &config_toolbar_style_def;
    gui_property->props[103].data.guint32.value = &config_toolbar_style;
    gui_property->props[103].data.guint32.max   = 0xFFFFFFFF;
    gui_property->props[103].data.guint32.min   = 0x00000000;
    gui_property->props[103].data.guint32.choices = config_toolbar_style_choices;
