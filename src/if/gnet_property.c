...
gnet_prop_init(void) {
    ...
    gnet_property->props[140].data.guint32.def   = &other_messages_kick_size_def;
    gnet_property->props[140].data.guint32.value = &other_messages_kick_size;
    ...
    gnet_property->props[141].data.guint32.def   = &hops_random_factor_def;
    gnet_property->props[141].data.guint32.value = &hops_random_factor;
    ...
    gnet_property->props[142].data.boolean.def   = &send_pushes_def;
    gnet_property->props[142].data.boolean.value = &send_pushes;
    ...
    gnet_property->props[143].data.guint32.def   = &min_dup_msg_def;
    gnet_property->props[143].data.guint32.value = &min_dup_msg;
    ...
    gnet_property->props[144].data.guint32.def   = &min_dup_ratio_def;
    gnet_property->props[144].data.guint32.value = &min_dup_ratio;
    ...
    gnet_property->props[145].data.string.def    = &scan_extensions_def;
    gnet_property->props[145].data.string.value  = &scan_extensions;
    ...
    gnet_property->props[146].data.boolean.def   = &scan_ignore_symlink_dirs_def;
    gnet_property->props[146].data.boolean.value = &scan_ignore_symlink_dirs;
    ...
    gnet_property->props[147].data.boolean.def   = &scan_ignore_symlink_regfiles_def;
    gnet_property->props[147].data.boolean.value = &scan_ignore_symlink_regfiles;
    ...
    gnet_property->props[148].data.string.def    = &save_file_path_def;
    gnet_property->props[148].data.string.value  = &save_file_path;
    ...
    gnet_property->props[149].data.string.def    = &move_file_path_def;
    gnet_property->props[149].data.string.value  = &move_file_path;
    ...
    gnet_property->props[150].data.string.def    = &bad_file_path_def;
    gnet_property->props[150].data.string.value  = &bad_file_path;
    ...
    gnet_property->props[151].data.string.def    = &shared_dirs_paths_def;
    gnet_property->props[151].data.string.value  = &shared_dirs_paths;
    ...
    gnet_property->props[152].data.string.def    = &local_netmasks_string_def;
    gnet_property->props[152].data.string.value  = &local_netmasks_string;
    ...
    gnet_property->props[153].data.guint32.def   = &total_downloads_def;
    gnet_property->props[153].data.guint32.value = &total_downloads;
    ...
    gnet_property->props[154].data.guint32.def   = &ul_running_def;
    gnet_property->props[154].data.guint32.value = &ul_running;
    ...
    gnet_property->props[155].data.guint32.def   = &ul_registered_def;
    gnet_property->props[155].data.guint32.value = &ul_registered;
    ...
    gnet_property->props[156].data.guint32.def   = &total_uploads_def;
    gnet_property->props[156].data.guint32.value = &total_uploads;
    ...
    gnet_property->props[157].data.storage.value = servent_guid;
    memset(servent_guid, 0, gnet_property->props[157].vector_size);
     ...
     * General data:
     */
    gnet_property->props[158].name = "use_swarming";
    gnet_property->props[158].desc = _("Whether or not to use swarming (recommended = YES).");
    gnet_property->props[158].ev_changed = event_new("use_swarming_changed");
    gnet_property->props[158].save = TRUE;
    gnet_property->props[158].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[158].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[158].data.boolean.def   = &use_swarming_def;
    gnet_property->props[158].data.boolean.value = &use_swarming;
     ...
     * General data:
     */
    gnet_property->props[159].name = "use_aggressive_swarming";
    gnet_property->props[159].desc = _("Whether or not to launch competing downloads when swarming and there are many sources available with a few chunks left.");
    gnet_property->props[159].ev_changed = event_new("use_aggressive_swarming_changed");
    gnet_property->props[159].save = TRUE;
    gnet_property->props[159].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[159].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[159].data.boolean.def   = &use_aggressive_swarming_def;
    gnet_property->props[159].data.boolean.value = &use_aggressive_swarming;
     ...
     * General data:
     */
    gnet_property->props[160].name = "dl_minchunksize";
    gnet_property->props[160].desc = _("Minimum chunk size when swarming.  This is only a hint as gtk-gnutella will download less if you only have a few bytes to get for a file...");
    gnet_property->props[160].ev_changed = event_new("dl_minchunksize_changed");
    gnet_property->props[160].save = TRUE;
    gnet_property->props[160].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[160].type               = PROP_TYPE_GUINT32;
    gnet_property->props[160].data.guint32.def   = &dl_minchunksize_def;
    gnet_property->props[160].data.guint32.value = &dl_minchunksize;
    gnet_property->props[160].data.guint32.choices = NULL;
    gnet_property->props[160].data.guint32.max   = 100*1024*1024;
    gnet_property->props[160].data.guint32.min   = 64*1024;
     ...
     * General data:
     */
    gnet_property->props[161].name = "dl_maxchunksize";
    gnet_property->props[161].desc = _("Maximum chunk size when swarming.");
    gnet_property->props[161].ev_changed = event_new("dl_maxchunksize_changed");
    gnet_property->props[161].save = TRUE;
    gnet_property->props[161].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[161].type               = PROP_TYPE_GUINT32;
    gnet_property->props[161].data.guint32.def   = &dl_maxchunksize_def;
    gnet_property->props[161].data.guint32.value = &dl_maxchunksize;
    gnet_property->props[161].data.guint32.choices = NULL;
    gnet_property->props[161].data.guint32.max   = 1000*1024*1024;
     ...
     * General data:
     */
    gnet_property->props[162].name = "auto_download_identical";
    gnet_property->props[162].desc = _("Whether or not to automatically queue search results that match a file in the download queue.");
    gnet_property->props[162].ev_changed = event_new("auto_download_identical_changed");
    gnet_property->props[162].save = TRUE;
    gnet_property->props[162].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[162].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[162].data.boolean.def   = &auto_download_identical_def;
    gnet_property->props[162].data.boolean.value = &auto_download_identical;
     ...
     * General data:
     */
    gnet_property->props[163].name = "auto_feed_download_mesh";
    gnet_property->props[163].desc = _("Whether or not to automatically feed the download mesh with data gathered from the query hits that flow through our node. This looks for new entries for files we are sharing or already have in our mesh.");
    gnet_property->props[163].ev_changed = event_new("auto_feed_download_mesh_changed");
    gnet_property->props[163].save = TRUE;
    gnet_property->props[163].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[163].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[163].data.boolean.def   = &auto_feed_download_mesh_def;
    gnet_property->props[163].data.boolean.value = &auto_feed_download_mesh;
     ...
     * General data:
     */
    gnet_property->props[164].name = "strict_sha1_matching";
    gnet_property->props[164].desc = _("When enabled, SHA1s must match. Otherwise, name and size will be sufficient.");
    gnet_property->props[164].ev_changed = event_new("strict_sha1_matching_changed");
    gnet_property->props[164].save = TRUE;
    gnet_property->props[164].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[164].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[164].data.boolean.def   = &strict_sha1_matching_def;
    gnet_property->props[164].data.boolean.value = &strict_sha1_matching;
     ...
     * General data:
     */
    gnet_property->props[165].name = "use_fuzzy_matching";
    gnet_property->props[165].desc = _("Use fuzzy file name matching (recommended = NO; only rely on SHA1 matching to be safe).");
    gnet_property->props[165].ev_changed = event_new("use_fuzzy_matching_changed");
    gnet_property->props[165].save = TRUE;
    gnet_property->props[165].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[165].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[165].data.boolean.def   = &use_fuzzy_matching_def;
    gnet_property->props[165].data.boolean.value = &use_fuzzy_matching;
     ...
     * General data:
     */
    gnet_property->props[166].name = "fuzzy_threshold";
    gnet_property->props[166].desc = _("Fuzziness threshold for filename matching (higher = stricter). A value of 100 means the filenames must be 100% identical.  A value of 0 means any two filenames will always be considered to be identical.  The minimum is 50%.");
    gnet_property->props[166].ev_changed = event_new("fuzzy_threshold_changed");
    gnet_property->props[166].save = TRUE;
    gnet_property->props[166].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[166].type               = PROP_TYPE_GUINT32;
    gnet_property->props[166].data.guint32.def   = &fuzzy_threshold_def;
    gnet_property->props[166].data.guint32.value = &fuzzy_threshold;
    gnet_property->props[166].data.guint32.choices = NULL;
    gnet_property->props[166].data.guint32.max   = 100;
    ...
    gnet_property->props[167].data.boolean.def   = &is_firewalled_def;
    gnet_property->props[167].data.boolean.value = &is_firewalled;
    ...
    gnet_property->props[168].data.boolean.def   = &is_inet_connected_def;
    gnet_property->props[168].data.boolean.value = &is_inet_connected;
    ...
    gnet_property->props[169].data.boolean.def   = &is_udp_firewalled_def;
    gnet_property->props[169].data.boolean.value = &is_udp_firewalled;
    ...
    gnet_property->props[170].data.boolean.def   = &recv_solicited_udp_def;
    gnet_property->props[170].data.boolean.value = &recv_solicited_udp;
    ...
    gnet_property->props[171].data.boolean.def   = &gnet_compact_query_def;
    gnet_property->props[171].data.boolean.value = &gnet_compact_query;
    ...
    gnet_property->props[172].data.boolean.def   = &download_optimistic_start_def;
    gnet_property->props[172].data.boolean.value = &download_optimistic_start;
    ...
    gnet_property->props[173].data.boolean.def   = &library_rebuilding_def;
    gnet_property->props[173].data.boolean.value = &library_rebuilding;
    ...
    gnet_property->props[174].data.boolean.def   = &sha1_rebuilding_def;
    gnet_property->props[174].data.boolean.value = &sha1_rebuilding;
    ...
    gnet_property->props[175].data.boolean.def   = &sha1_verifying_def;
    gnet_property->props[175].data.boolean.value = &sha1_verifying;
    ...
    gnet_property->props[176].data.boolean.def   = &file_moving_def;
    gnet_property->props[176].data.boolean.value = &file_moving;
    ...
    gnet_property->props[177].data.boolean.def   = &prefer_compressed_gnet_def;
    gnet_property->props[177].data.boolean.value = &prefer_compressed_gnet;
    ...
    gnet_property->props[178].data.boolean.def   = &online_mode_def;
    gnet_property->props[178].data.boolean.value = &online_mode;
    ...
    gnet_property->props[179].data.boolean.def   = &download_require_urn_def;
    gnet_property->props[179].data.boolean.value = &download_require_urn;
    ...
    gnet_property->props[180].data.boolean.def   = &download_require_server_name_def;
    gnet_property->props[180].data.boolean.value = &download_require_server_name;
    ...
    gnet_property->props[181].data.guint32.def   = &max_ultrapeers_def;
    gnet_property->props[181].data.guint32.value = &max_ultrapeers;
    gnet_property->props[181].data.guint32.choices = NULL;
    gnet_property->props[181].data.guint32.max   = 4;
    ...
    gnet_property->props[182].data.guint32.def   = &quick_connect_pool_size_def;
    gnet_property->props[182].data.guint32.value = &quick_connect_pool_size;
    ...
    gnet_property->props[183].desc = _("Maximum amount of leaves we can accept.  To be promoted Ultra, you should reserve 32 bytes of bandwidth per leaf.");
    ...
    gnet_property->props[183].data.guint32.def   = &max_leaves_def;
    gnet_property->props[183].data.guint32.value = &max_leaves;
    gnet_property->props[183].data.guint32.choices = NULL;
    gnet_property->props[183].data.guint32.max   = 1000;
    gnet_property->props[183].data.guint32.min   = 50;
    ...
    gnet_property->props[184].data.guint32.def   = &search_handle_ignored_files_def;
    gnet_property->props[184].data.guint32.value = &search_handle_ignored_files;
    gnet_property->props[184].data.guint32.max   = 0xFFFFFFFF;
    gnet_property->props[184].data.guint32.min   = 0x00000000;
    gnet_property->props[184].data.guint32.choices = search_handle_ignored_files_choices;
    ...
    gnet_property->props[185].data.guint32.def   = &configured_peermode_def;
    gnet_property->props[185].data.guint32.value = &configured_peermode;
    gnet_property->props[185].data.guint32.max   = 0xFFFFFFFF;
    gnet_property->props[185].data.guint32.min   = 0x00000000;
    gnet_property->props[185].data.guint32.choices = configured_peermode_choices;
    ...
    gnet_property->props[186].data.guint32.def   = &current_peermode_def;
    gnet_property->props[186].data.guint32.value = &current_peermode;
    gnet_property->props[186].data.guint32.max   = 0xFFFFFFFF;
    gnet_property->props[186].data.guint32.min   = 0x00000000;
    gnet_property->props[186].data.guint32.choices = current_peermode_choices;
    ...
    gnet_property->props[187].data.guint32.def   = &sys_nofile_def;
    gnet_property->props[187].data.guint32.value = &sys_nofile;
    ...
    gnet_property->props[188].data.guint64.def   = &sys_physmem_def;
    gnet_property->props[188].data.guint64.value = &sys_physmem;
    ...
    gnet_property->props[189].data.guint32.def   = &dl_queue_count_def;
    gnet_property->props[189].data.guint32.value = &dl_queue_count;
    ...
    gnet_property->props[190].data.guint32.def   = &dl_running_count_def;
    gnet_property->props[190].data.guint32.value = &dl_running_count;
    ...
    gnet_property->props[191].data.guint32.def   = &dl_active_count_def;
    gnet_property->props[191].data.guint32.value = &dl_active_count;
    ...
    gnet_property->props[192].data.guint32.def   = &dl_aqueued_count_def;
    gnet_property->props[192].data.guint32.value = &dl_aqueued_count;
    ...
    gnet_property->props[193].data.guint32.def   = &dl_pqueued_count_def;
    gnet_property->props[193].data.guint32.value = &dl_pqueued_count;
    ...
    gnet_property->props[194].data.guint32.def   = &fi_all_count_def;
    gnet_property->props[194].data.guint32.value = &fi_all_count;
    ...
    gnet_property->props[195].data.guint32.def   = &fi_with_source_count_def;
    gnet_property->props[195].data.guint32.value = &fi_with_source_count;
    ...
    gnet_property->props[196].data.guint32.def   = &dl_qalive_count_def;
    gnet_property->props[196].data.guint32.value = &dl_qalive_count;
    ...
    gnet_property->props[197].data.guint64.def   = &dl_byte_count_def;
    gnet_property->props[197].data.guint64.value = &dl_byte_count;
    ...
    gnet_property->props[198].data.guint64.def   = &ul_byte_count_def;
    gnet_property->props[198].data.guint64.value = &ul_byte_count;
    ...
    gnet_property->props[199].data.boolean.def   = &pfsp_server_def;
    gnet_property->props[199].data.boolean.value = &pfsp_server;
    ...
    gnet_property->props[200].data.guint32.def   = &pfsp_first_chunk_def;
    gnet_property->props[200].data.guint32.value = &pfsp_first_chunk;
    ...
    gnet_property->props[201].data.guint32.def   = &pfsp_minimum_filesize_def;
    gnet_property->props[201].data.guint32.value = &pfsp_minimum_filesize;
    ...
    gnet_property->props[203].data.guint32.def   = &crawler_visit_count_def;
    gnet_property->props[203].data.guint32.value = &crawler_visit_count;
    ...
    gnet_property->props[204].data.guint32.def   = &udp_crawler_visit_count_def;
    gnet_property->props[204].data.guint32.value = &udp_crawler_visit_count;
    ...
    gnet_property->props[205].data.boolean.def   = &host_runs_ntp_def;
    gnet_property->props[205].data.boolean.value = &host_runs_ntp;
    ...
    gnet_property->props[206].data.boolean.def   = &ntp_detected_def;
    gnet_property->props[206].data.boolean.value = &ntp_detected;
    ...
    gnet_property->props[207].data.guint32.def   = &clock_skew_def;
    gnet_property->props[207].data.guint32.value = &clock_skew;
    ...
    gnet_property->props[208].data.boolean.def   = &node_monitor_unstable_ip_def;
    gnet_property->props[208].data.boolean.value = &node_monitor_unstable_ip;
    ...
    gnet_property->props[209].data.boolean.def   = &node_monitor_unstable_servents_def;
    gnet_property->props[209].data.boolean.value = &node_monitor_unstable_servents;
    ...
    gnet_property->props[210].data.boolean.def   = &dl_remove_file_on_mismatch_def;
    gnet_property->props[210].data.boolean.value = &dl_remove_file_on_mismatch;
    ...
    gnet_property->props[211].data.guint32.def   = &dl_mismatch_backout_def;
    gnet_property->props[211].data.guint32.value = &dl_mismatch_backout;
    ...
    gnet_property->props[212].data.string.def    = &server_hostname_def;
    gnet_property->props[212].data.string.value  = &server_hostname;
    ...
    gnet_property->props[213].data.boolean.def   = &give_server_hostname_def;
    gnet_property->props[213].data.boolean.value = &give_server_hostname;
    ...
    gnet_property->props[214].data.guint32.def   = &reserve_gtkg_nodes_def;
    gnet_property->props[214].data.guint32.value = &reserve_gtkg_nodes;
    ...
    gnet_property->props[215].data.guint32.def   = &unique_nodes_def;
    gnet_property->props[215].data.guint32.value = &unique_nodes;
    ...
    gnet_property->props[216].desc = _("Size of the RX socket buffer to be used for downloads, in kbytes. If you wish to avoid Gnutella downloads using up all your bandwidth, set it to a low value (default is 64K, which is fine). If you don't mind sucking up all the available bandwidth, increasing your connection latency, set it to a greater value. Remember: the smaller the value, the more you will be able to precisely control the incoming rate.");
    ...
    gnet_property->props[216].data.guint32.def   = &download_rx_size_def;
    gnet_property->props[216].data.guint32.value = &download_rx_size;
    ...
    gnet_property->props[217].data.guint32.def   = &node_rx_size_def;
    gnet_property->props[217].data.guint32.value = &node_rx_size;
    ...
    gnet_property->props[218].data.guint32.def   = &dl_http_latency_def;
    gnet_property->props[218].data.guint32.value = &dl_http_latency;
    ...
    gnet_property->props[219].data.timestamp.def   = &node_last_ultra_check_def;
    gnet_property->props[219].data.timestamp.value = &node_last_ultra_check;
    ...
    gnet_property->props[220].data.timestamp.def   = &node_last_ultra_leaf_switch_def;
    gnet_property->props[220].data.timestamp.value = &node_last_ultra_leaf_switch;
    ...
    gnet_property->props[221].data.boolean.def   = &up_req_avg_servent_uptime_def;
    gnet_property->props[221].data.boolean.value = &up_req_avg_servent_uptime;
    ...
    gnet_property->props[222].data.boolean.def   = &up_req_avg_ip_uptime_def;
    gnet_property->props[222].data.boolean.value = &up_req_avg_ip_uptime;
    ...
    gnet_property->props[223].data.boolean.def   = &up_req_node_uptime_def;
    gnet_property->props[223].data.boolean.value = &up_req_node_uptime;
    ...
    gnet_property->props[224].data.boolean.def   = &up_req_not_firewalled_def;
    gnet_property->props[224].data.boolean.value = &up_req_not_firewalled;
    ...
    gnet_property->props[225].data.boolean.def   = &up_req_enough_conn_def;
    gnet_property->props[225].data.boolean.value = &up_req_enough_conn;
    ...
    gnet_property->props[226].data.boolean.def   = &up_req_enough_fd_def;
    gnet_property->props[226].data.boolean.value = &up_req_enough_fd;
    ...
    gnet_property->props[227].data.boolean.def   = &up_req_enough_mem_def;
    gnet_property->props[227].data.boolean.value = &up_req_enough_mem;
    ...
    gnet_property->props[228].data.boolean.def   = &up_req_enough_bw_def;
    gnet_property->props[228].data.boolean.value = &up_req_enough_bw;
    ...
    gnet_property->props[229].data.guint32.def   = &search_queue_size_def;
    gnet_property->props[229].data.guint32.value = &search_queue_size;
    ...
    gnet_property->props[230].data.guint32.def   = &search_queue_spacing_def;
    gnet_property->props[230].data.guint32.value = &search_queue_spacing;
    ...
    gnet_property->props[231].data.boolean.def   = &enable_shell_def;
    gnet_property->props[231].data.boolean.value = &enable_shell;
    ...
    gnet_property->props[232].data.guint32.def   = &entry_removal_timeout_def;
    gnet_property->props[232].data.guint32.value = &entry_removal_timeout;
    ...
    gnet_property->props[233].data.boolean.def   = &node_watch_similar_queries_def;
    gnet_property->props[233].data.boolean.value = &node_watch_similar_queries;
    ...
    gnet_property->props[234].data.guint32.def   = &node_queries_half_life_def;
    gnet_property->props[234].data.guint32.value = &node_queries_half_life;
    ...
    gnet_property->props[235].data.guint32.def   = &node_requery_threshold_def;
    gnet_property->props[235].data.guint32.value = &node_requery_threshold;
    ...
    gnet_property->props[236].data.timestamp.def   = &library_rescan_started_def;
    gnet_property->props[236].data.timestamp.value = &library_rescan_started;
    ...
    gnet_property->props[237].data.timestamp.def   = &library_rescan_finished_def;
    gnet_property->props[237].data.timestamp.value = &library_rescan_finished;
    ...
    gnet_property->props[238].data.guint32.def   = &library_rescan_duration_def;
    gnet_property->props[238].data.guint32.value = &library_rescan_duration;
    ...
    gnet_property->props[239].data.timestamp.def   = &qrp_indexing_started_def;
    gnet_property->props[239].data.timestamp.value = &qrp_indexing_started;
    ...
    gnet_property->props[240].data.guint32.def   = &qrp_indexing_duration_def;
    gnet_property->props[240].data.guint32.value = &qrp_indexing_duration;
     ...
     * General data:
     */
    gnet_property->props[241].name = "qrp_timestamp";
    gnet_property->props[241].desc = _("Time at which we started query routing table generation.");
    gnet_property->props[241].ev_changed = event_new("qrp_timestamp_changed");
    gnet_property->props[241].save = FALSE;
    gnet_property->props[241].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[241].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[241].data.timestamp.def   = &qrp_timestamp_def;
    gnet_property->props[241].data.timestamp.value = &qrp_timestamp;
     ...
     * General data:
     */
    gnet_property->props[242].name = "qrp_computation_time";
    gnet_property->props[242].desc = _("Time spent computing the QRP table, in seconds.");
    gnet_property->props[242].ev_changed = event_new("qrp_computation_time_changed");
    gnet_property->props[242].save = FALSE;
    gnet_property->props[242].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[242].type               = PROP_TYPE_GUINT32;
    gnet_property->props[242].data.guint32.def   = &qrp_computation_time_def;
    gnet_property->props[242].data.guint32.value = &qrp_computation_time;
     ...
     * General data:
     */
    gnet_property->props[243].name = "qrp_patch_timestamp";
    gnet_property->props[243].desc = _("Time at which we started computing our QRP patch.");
    gnet_property->props[243].ev_changed = event_new("qrp_patch_timestamp_changed");
    gnet_property->props[243].save = FALSE;
    gnet_property->props[243].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[243].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[243].data.timestamp.def   = &qrp_patch_timestamp_def;
    gnet_property->props[243].data.timestamp.value = &qrp_patch_timestamp;
     ...
     * General data:
     */
    gnet_property->props[244].name = "qrp_patch_computation_time";
    gnet_property->props[244].desc = _("Time spent computing the QRP table patch, in seconds.");
    gnet_property->props[244].ev_changed = event_new("qrp_patch_computation_time_changed");
    gnet_property->props[244].save = FALSE;
    gnet_property->props[244].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[244].type               = PROP_TYPE_GUINT32;
    gnet_property->props[244].data.guint32.def   = &qrp_patch_computation_time_def;
    gnet_property->props[244].data.guint32.value = &qrp_patch_computation_time;
     ...
     * General data:
     */
    gnet_property->props[245].name = "qrp_generation";
    gnet_property->props[245].desc = _("Query routing table generation number.");
    gnet_property->props[245].ev_changed = event_new("qrp_generation_changed");
    gnet_property->props[245].save = FALSE;
    gnet_property->props[245].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[245].type               = PROP_TYPE_GUINT32;
    gnet_property->props[245].data.guint32.def   = &qrp_generation_def;
    gnet_property->props[245].data.guint32.value = &qrp_generation;
     ...
     * General data:
     */
    gnet_property->props[246].name = "qrp_slots";
    gnet_property->props[246].desc = _("Amount of slots used by our QRP table.");
    gnet_property->props[246].ev_changed = event_new("qrp_slots_changed");
    gnet_property->props[246].save = FALSE;
    gnet_property->props[246].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[246].type               = PROP_TYPE_GUINT32;
    gnet_property->props[246].data.guint32.def   = &qrp_slots_def;
    gnet_property->props[246].data.guint32.value = &qrp_slots;
     ...
     * General data:
     */
    gnet_property->props[247].name = "qrp_slots_filled";
    gnet_property->props[247].desc = _("Amount of slots filled within our QRP table.");
    gnet_property->props[247].ev_changed = event_new("qrp_slots_filled_changed");
    gnet_property->props[247].save = FALSE;
    gnet_property->props[247].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[247].type               = PROP_TYPE_GUINT32;
    gnet_property->props[247].data.guint32.def   = &qrp_slots_filled_def;
    gnet_property->props[247].data.guint32.value = &qrp_slots_filled;
     ...
     * General data:
     */
    gnet_property->props[248].name = "qrp_fill_ratio";
    gnet_property->props[248].desc = _("Percentage of slots filled within our QRP table.");
    gnet_property->props[248].ev_changed = event_new("qrp_fill_ratio_changed");
    gnet_property->props[248].save = FALSE;
    gnet_property->props[248].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[248].type               = PROP_TYPE_GUINT32;
    gnet_property->props[248].data.guint32.def   = &qrp_fill_ratio_def;
    gnet_property->props[248].data.guint32.value = &qrp_fill_ratio;
     ...
     * General data:
     */
    gnet_property->props[249].name = "qrp_conflict_ratio";
    gnet_property->props[249].desc = _("Percentage of hashing conflicts whilst inserting data in our QRP table.");
    gnet_property->props[249].ev_changed = event_new("qrp_conflict_ratio_changed");
    gnet_property->props[249].save = FALSE;
    gnet_property->props[249].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[249].type               = PROP_TYPE_GUINT32;
    gnet_property->props[249].data.guint32.def   = &qrp_conflict_ratio_def;
    gnet_property->props[249].data.guint32.value = &qrp_conflict_ratio;
     ...
     * General data:
     */
    gnet_property->props[250].name = "qrp_hashed_keywords";
    gnet_property->props[250].desc = _("Amount of hashed keywords in our QRP table.");
    gnet_property->props[250].ev_changed = event_new("qrp_hashed_keywords_changed");
    gnet_property->props[250].save = FALSE;
    gnet_property->props[250].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[250].type               = PROP_TYPE_GUINT32;
    gnet_property->props[250].data.guint32.def   = &qrp_hashed_keywords_def;
    gnet_property->props[250].data.guint32.value = &qrp_hashed_keywords;
     ...
     * General data:
     */
    gnet_property->props[251].name = "qrp_patch_raw_length";
    gnet_property->props[251].desc = _("Total raw size of the QRP table patch, in bytes.");
    gnet_property->props[251].ev_changed = event_new("qrp_patch_raw_length_changed");
    gnet_property->props[251].save = FALSE;
    gnet_property->props[251].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[251].type               = PROP_TYPE_GUINT32;
    gnet_property->props[251].data.guint32.def   = &qrp_patch_raw_length_def;
    gnet_property->props[251].data.guint32.value = &qrp_patch_raw_length;
     ...
     * General data:
     */
    gnet_property->props[252].name = "qrp_patch_length";
    gnet_property->props[252].desc = _("Final QRP table patch length, after possible compression.");
    gnet_property->props[252].ev_changed = event_new("qrp_patch_length_changed");
    gnet_property->props[252].save = FALSE;
    gnet_property->props[252].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[252].type               = PROP_TYPE_GUINT32;
    gnet_property->props[252].data.guint32.def   = &qrp_patch_length_def;
    gnet_property->props[252].data.guint32.value = &qrp_patch_length;
     ...
     * General data:
     */
    gnet_property->props[253].name = "qrp_patch_comp_ratio";
    gnet_property->props[253].desc = _("QRP table patch compression ratio, in percent, 0 means none.");
    gnet_property->props[253].ev_changed = event_new("qrp_patch_comp_ratio_changed");
    gnet_property->props[253].save = FALSE;
    gnet_property->props[253].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[253].type               = PROP_TYPE_GUINT32;
    gnet_property->props[253].data.guint32.def   = &qrp_patch_comp_ratio_def;
    gnet_property->props[253].data.guint32.value = &qrp_patch_comp_ratio;
     ...
     * General data:
     */
    gnet_property->props[254].name = "ancient_version_force";
    gnet_property->props[254].desc = _("This property must be set to the current version number of gtk-gnutella in order to allow it to run when it is ancient.");
    gnet_property->props[254].ev_changed = event_new("ancient_version_force_changed");
    gnet_property->props[254].save = TRUE;
    gnet_property->props[254].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[254].type               = PROP_TYPE_STRING;
    gnet_property->props[254].data.string.def    = &ancient_version_force_def;
    gnet_property->props[254].data.string.value  = &ancient_version_force;
    if (gnet_property->props[254].data.string.def) {
        *gnet_property->props[254].data.string.value =
            g_strdup(eval_subst(*gnet_property->props[254].data.string.def));
    }
    ...
    gnet_property->props[255].data.guint32.def   = &ancient_version_left_days_def;
    gnet_property->props[255].data.guint32.value = &ancient_version_left_days;
    ...
    gnet_property->props[256].data.boolean.def   = &file_descriptor_shortage_def;
    gnet_property->props[256].data.boolean.value = &file_descriptor_shortage;
    ...
    gnet_property->props[257].data.boolean.def   = &file_descriptor_runout_def;
    gnet_property->props[257].data.boolean.value = &file_descriptor_runout;
    ...
    gnet_property->props[258].data.boolean.def   = &convert_spaces_def;
    gnet_property->props[258].data.boolean.value = &convert_spaces;
    ...
    gnet_property->props[259].data.boolean.def   = &convert_evil_chars_def;
    gnet_property->props[259].data.boolean.value = &convert_evil_chars;
    ...
    gnet_property->props[260].data.boolean.def   = &convert_old_filenames_def;
    gnet_property->props[260].data.boolean.value = &convert_old_filenames;
    ...
    gnet_property->props[261].data.boolean.def   = &tls_enforce_def;
    gnet_property->props[261].data.boolean.value = &tls_enforce;
    ...
    gnet_property->props[262].data.boolean.def   = &gnet_deflate_enabled_def;
    gnet_property->props[262].data.boolean.value = &gnet_deflate_enabled;
    ...
    gnet_property->props[263].data.boolean.def   = &enable_udp_def;
    gnet_property->props[263].data.boolean.value = &enable_udp;
    ...
    gnet_property->props[264].data.boolean.def   = &process_oob_queries_def;
    gnet_property->props[264].data.boolean.value = &process_oob_queries;
    ...
    gnet_property->props[265].data.boolean.def   = &send_oob_queries_def;
    gnet_property->props[265].data.boolean.value = &send_oob_queries;
    ...
    gnet_property->props[266].data.boolean.def   = &proxy_oob_queries_def;
    gnet_property->props[266].data.boolean.value = &proxy_oob_queries;
    ...
    gnet_property->props[267].data.boolean.def   = &uploads_stalling_def;
    gnet_property->props[267].data.boolean.value = &uploads_stalling;
    ...
    gnet_property->props[268].data.boolean.def   = &use_global_hostiles_txt_def;
    gnet_property->props[268].data.boolean.value = &use_global_hostiles_txt;
    ...
    gnet_property->props[269].data.boolean.def   = &use_so_linger_def;
    gnet_property->props[269].data.boolean.value = &use_so_linger;
    ...
    gnet_property->props[270].data.guint32.def   = &tcp_defer_accept_timeout_def;
    gnet_property->props[270].data.guint32.value = &tcp_defer_accept_timeout;
    ...
    gnet_property->props[271].data.boolean.def   = &browse_host_enabled_def;
    gnet_property->props[271].data.boolean.value = &browse_host_enabled;
    ...
    gnet_property->props[272].data.guint32.def   = &html_browse_count_def;
    gnet_property->props[272].data.guint32.value = &html_browse_count;
    ...
    gnet_property->props[273].data.guint32.def   = &html_browse_served_def;
    gnet_property->props[273].data.guint32.value = &html_browse_served;
    ...
    gnet_property->props[274].data.guint32.def   = &qhits_browse_count_def;
    gnet_property->props[274].data.guint32.value = &qhits_browse_count;
    ...
    gnet_property->props[275].data.guint32.def   = &qhits_browse_served_def;
    gnet_property->props[275].data.guint32.value = &qhits_browse_served;
    ...
    gnet_property->props[276].data.boolean.def   = &overloaded_cpu_def;
    gnet_property->props[276].data.boolean.value = &overloaded_cpu;
    ...
    gnet_property->props[277].data.guint32.def   = &download_buffer_size_def;
    gnet_property->props[277].data.guint32.value = &download_buffer_size;
     ...
     * General data:
     */
    gnet_property->props[278].name = "download_buffer_read_ahead";
    gnet_property->props[278].desc = _("Extra amount of data per downloading source that gtk-gnutella will try to read-ahead.  This gives more room for reading large amount of data without issuing too many system calls. It complements buffering nicely because it prevents reading a few bytes before committing the buffered data to disk: when read-ahead space is available, it will be used in addition to buffering, but read-ahead data is committed to disk immediately.  If you don't wish to reserve more memory per active source, you can disable this feature by setting the read-ahead buffer size to 0.");
    gnet_property->props[278].ev_changed = event_new("download_buffer_read_ahead_changed");
    gnet_property->props[278].save = TRUE;
    gnet_property->props[278].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[278].type               = PROP_TYPE_GUINT32;
    gnet_property->props[278].data.guint32.def   = &download_buffer_read_ahead_def;
    gnet_property->props[278].data.guint32.value = &download_buffer_read_ahead;
    gnet_property->props[278].data.guint32.choices = NULL;
    gnet_property->props[278].data.guint32.max   = 16384;
     ...
     * General data:
     */
    gnet_property->props[279].name = "browse_copied_to_passive";
    gnet_property->props[279].desc = _("When set, all search results from host browsing are dispatched to all opened passive searches.  This is useful if you have different selection filters on your passive searches because it lets you classify files easily, regardless of the origin of the files.");
    gnet_property->props[279].ev_changed = event_new("browse_copied_to_passive_changed");
    gnet_property->props[279].save = TRUE;
    gnet_property->props[279].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[279].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[279].data.boolean.def   = &browse_copied_to_passive_def;
    gnet_property->props[279].data.boolean.value = &browse_copied_to_passive;
    ...
    gnet_property->props[280].data.boolean.def   = &display_metric_units_def;
    gnet_property->props[280].data.boolean.value = &display_metric_units;
