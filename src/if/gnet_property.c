...
gchar   *gnet_property_variable_scan_extensions     = "aac;avi;bin;bz2;7z;cue;deb;divx;doc;flac;flc;fli;gif;gz;ifo;iso;it;jpeg;jpg;m4a;mjpg;mka;mkv;mod;mov;mp1;mp2;mp3;mp4;mpa;mpeg;mpega;mpg;mpv;nes;oga;ogg;ogm;ogv;qt;pdf;png;ps;ram;rar;rm;rom;rpm;s3m;shn;sid;smc;smd;srt;stm;tar;tbz2;tgz;torrent;txt;vob;voc;vqf;wav;xm;xvid;zip";
static const gchar   *gnet_property_variable_scan_extensions_default = "aac;avi;bin;bz2;7z;cue;deb;divx;doc;flac;flc;fli;gif;gz;ifo;iso;it;jpeg;jpg;m4a;mjpg;mka;mkv;mod;mov;mp1;mp2;mp3;mp4;mpa;mpeg;mpega;mpg;mpv;nes;oga;ogg;ogm;ogv;qt;pdf;png;ps;ram;rar;rm;rom;rpm;s3m;shn;sid;smc;smd;srt;stm;tar;tbz2;tgz;torrent;txt;vob;voc;vqf;wav;xm;xvid;zip";
...
gnet_prop_init(void) {
     ...
     * General data:
     */
    gnet_property->props[300].name = "session_id";
    gnet_property->props[300].desc = _("The current Session ID.");
    gnet_property->props[300].ev_changed = event_new("session_id_changed");
    gnet_property->props[300].save = FALSE;
    gnet_property->props[300].vector_size = GUID_RAW_SIZE;

    /* Type specific data: */
    gnet_property->props[300].type               = PROP_TYPE_STORAGE;
    gnet_property->props[300].data.storage.value = gnet_property_variable_session_id;
