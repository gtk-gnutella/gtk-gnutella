...
static const guint32  gnet_property_variable_download_retry_timeout_max_default = 300;
...
static const guint32  gnet_property_variable_download_retry_timeout_delay_default = 1200;
...
static const guint32  gnet_property_variable_download_retry_refused_delay_default = 1800;
...
static const gboolean gnet_property_variable_clear_complete_downloads_default = FALSE;
gboolean gnet_property_variable_clear_failed_downloads     = FALSE;
static const gboolean gnet_property_variable_clear_failed_downloads_default = FALSE;
...
static const gchar   *gnet_property_variable_scan_extensions_default = "aac;avi;bin;bz2;cue;deb;divx;doc;flac;flc;fli;gif;gz;ifo;iso;it;jpeg;jpg;m4a;mjpg;mka;mkv;mod;mov;mp1;mp2;mp3;mp4;mpa;mpeg;mpega;mpg;mpv;nes;ogg;ogm;qt;pdf;png;ps;ram;rar;rm;rom;rpm;s3m;shn;sid;smc;smd;srt;stm;tar;tgz;torrent;txt;vob;voc;vqf;wav;xm;xvid;zip";
...
static const gboolean gnet_property_variable_node_monitor_unstable_ip_default = TRUE;
...
gnet_prop_init(void) {
    ...
    gnet_property->props[121].data.guint32.max   = 999999;
    ...
    gnet_property->props[122].desc = _("Current number of hosts in ultra node caches.");
    ...
    gnet_property->props[124].desc = _("Maximum number of hosts in the regular node catcher.");
    ...
    gnet_property->props[125].desc = _("Maximum number of hosts in the ultra node catcher.");
    ...
    gnet_property->props[139].desc = _("Maximum number of Query MUIDs to track. This allows mapping MUIDs of Query Hits to the original search term. In the worst case this causes about 300 bytes per Query of memory overhead.");
    ...
    gnet_property->props[139].data.guint32.max   = 1000000;
     ...
     * General data:
     */
    gnet_property->props[158].name = "servent_kuid";
    gnet_property->props[158].desc = _("Kademlia Unique IDentifier of this node in the DHT.");
    gnet_property->props[158].ev_changed = event_new("servent_kuid_changed");
    ...
    gnet_property->props[158].data.storage.value = gnet_property_variable_servent_kuid;
    ...
    gnet_property->props[180].data.guint32.max   = 4;
    ...
    gnet_property->props[181].data.guint32.min   = 4;
    ...
    gnet_property->props[182].desc = _("Maximum amount of leaves we can accept.  To be promoted Ultra, you should reserve 32 bytes of bandwidth per leaf.");
    ...
    gnet_property->props[182].data.guint32.max   = 1000;
    ...
    gnet_property->props[214].desc = _("Size of the RX socket buffer to be used for downloads, in kbytes. If you wish to avoid Gnutella downloads using up all your bandwidth, set it to a low value (default is 64K, which is fine). If you don't mind sucking up all the available bandwidth, increasing your connection latency, set it to a greater value. Remember: the smaller the value, the more you will be able to precisely control the incoming rate.");
    ...
    gnet_property->props[214].data.guint32.max   = 128;
    gnet_property->props[214].data.guint32.min   = 2;
    ...
    gnet_property->props[215].data.guint32.min   = 2;
     ...
     * General data:
     */
    gnet_property->props[216].name = "dl_http_latency";
    gnet_property->props[216].desc = _("Average recent latency between the sending of the HTTP request and the reception of the reply from the remote server, in msecs.");
    gnet_property->props[216].ev_changed = event_new("dl_http_latency_changed");
    gnet_property->props[216].save = FALSE;
    gnet_property->props[216].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[216].type               = PROP_TYPE_GUINT32;
    gnet_property->props[216].data.guint32.def   = (void *) &gnet_property_variable_dl_http_latency_default;
    gnet_property->props[216].data.guint32.value = (void *) &gnet_property_variable_dl_http_latency;
     ...
     * General data:
     */
    gnet_property->props[217].name = "node_last_ultra_check";
    gnet_property->props[217].desc = _("Last time at which we performed the ultrapeer requirement checks.");
    gnet_property->props[217].ev_changed = event_new("node_last_ultra_check_changed");
    gnet_property->props[217].save = TRUE;
    gnet_property->props[217].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[217].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[217].data.timestamp.def   = (void *) &gnet_property_variable_node_last_ultra_check_default;
    gnet_property->props[217].data.timestamp.value = (void *) &gnet_property_variable_node_last_ultra_check;
    gnet_property->props[217].data.timestamp.choices = NULL;
    gnet_property->props[217].data.timestamp.max   = (time_t) ((1U << 31) - 1);
    gnet_property->props[217].data.timestamp.min   = 0x0000000000000000;
     ...
     * General data:
     */
    gnet_property->props[218].name = "node_last_ultra_leaf_switch";
    gnet_property->props[218].desc = _("Last time an automatic switch between ultra and leaf mode occurred.");
    gnet_property->props[218].ev_changed = event_new("node_last_ultra_leaf_switch_changed");
    gnet_property->props[218].save = FALSE;
    gnet_property->props[218].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[218].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[218].data.timestamp.def   = (void *) &gnet_property_variable_node_last_ultra_leaf_switch_default;
    gnet_property->props[218].data.timestamp.value = (void *) &gnet_property_variable_node_last_ultra_leaf_switch;
     ...
     * General data:
     */
    gnet_property->props[219].name = "up_req_avg_servent_uptime";
    gnet_property->props[219].desc = _("Whether we meet the sufficient average uptime requirement to become an Ultra node.");
    gnet_property->props[219].ev_changed = event_new("up_req_avg_servent_uptime_changed");
    gnet_property->props[219].save = FALSE;
    gnet_property->props[219].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[219].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[219].data.boolean.def   = (void *) &gnet_property_variable_up_req_avg_servent_uptime_default;
    gnet_property->props[219].data.boolean.value = (void *) &gnet_property_variable_up_req_avg_servent_uptime;
     ...
     * General data:
     */
    gnet_property->props[220].name = "up_req_avg_ip_uptime";
    gnet_property->props[220].desc = _("Whether we meet the sufficient average IP address uptime requirement to become an Ultra node.");
    gnet_property->props[220].ev_changed = event_new("up_req_avg_ip_uptime_changed");
    gnet_property->props[220].save = FALSE;
    gnet_property->props[220].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[220].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[220].data.boolean.def   = (void *) &gnet_property_variable_up_req_avg_ip_uptime_default;
    gnet_property->props[220].data.boolean.value = (void *) &gnet_property_variable_up_req_avg_ip_uptime;
     ...
     * General data:
     */
    gnet_property->props[221].name = "up_req_node_uptime";
    gnet_property->props[221].desc = _("Whether we meet the sufficient node uptime requirement to become an Ultra node.");
    gnet_property->props[221].ev_changed = event_new("up_req_node_uptime_changed");
    gnet_property->props[221].save = FALSE;
    gnet_property->props[221].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[221].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[221].data.boolean.def   = (void *) &gnet_property_variable_up_req_node_uptime_default;
    gnet_property->props[221].data.boolean.value = (void *) &gnet_property_variable_up_req_node_uptime;
     ...
     * General data:
     */
    gnet_property->props[222].name = "up_req_not_firewalled";
    gnet_property->props[222].desc = _("Whether we meet the non-firewalled requirement to become an Ultra node.");
    gnet_property->props[222].ev_changed = event_new("up_req_not_firewalled_changed");
    gnet_property->props[222].save = FALSE;
    gnet_property->props[222].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[222].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[222].data.boolean.def   = (void *) &gnet_property_variable_up_req_not_firewalled_default;
    gnet_property->props[222].data.boolean.value = (void *) &gnet_property_variable_up_req_not_firewalled;
     ...
     * General data:
     */
    gnet_property->props[223].name = "up_req_enough_conn";
    gnet_property->props[223].desc = _("Whether we meet the minimum amount of peer connections requirement to become an Ultra node.");
    gnet_property->props[223].ev_changed = event_new("up_req_enough_conn_changed");
    gnet_property->props[223].save = FALSE;
    gnet_property->props[223].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[223].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[223].data.boolean.def   = (void *) &gnet_property_variable_up_req_enough_conn_default;
    gnet_property->props[223].data.boolean.value = (void *) &gnet_property_variable_up_req_enough_conn;
     ...
     * General data:
     */
    gnet_property->props[224].name = "up_req_enough_fd";
    gnet_property->props[224].desc = _("Whether we meet the amount of file descriptor requirement to become an Ultra node.");
    gnet_property->props[224].ev_changed = event_new("up_req_enough_fd_changed");
    gnet_property->props[224].save = FALSE;
    gnet_property->props[224].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[224].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[224].data.boolean.def   = (void *) &gnet_property_variable_up_req_enough_fd_default;
    gnet_property->props[224].data.boolean.value = (void *) &gnet_property_variable_up_req_enough_fd;
     ...
     * General data:
     */
    gnet_property->props[225].name = "up_req_enough_mem";
    gnet_property->props[225].desc = _("Whether we meet the memory requirements to become an Ultra node.");
    gnet_property->props[225].ev_changed = event_new("up_req_enough_mem_changed");
    gnet_property->props[225].save = FALSE;
    gnet_property->props[225].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[225].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[225].data.boolean.def   = (void *) &gnet_property_variable_up_req_enough_mem_default;
    gnet_property->props[225].data.boolean.value = (void *) &gnet_property_variable_up_req_enough_mem;
     ...
     * General data:
     */
    gnet_property->props[226].name = "up_req_enough_bw";
    gnet_property->props[226].desc = _("Whether we meet the bandwidth requirements to become an Ultra node.");
    gnet_property->props[226].ev_changed = event_new("up_req_enough_bw_changed");
    gnet_property->props[226].save = FALSE;
    gnet_property->props[226].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[226].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[226].data.boolean.def   = (void *) &gnet_property_variable_up_req_enough_bw_default;
    gnet_property->props[226].data.boolean.value = (void *) &gnet_property_variable_up_req_enough_bw;
     ...
     * General data:
     */
    gnet_property->props[227].name = "up_req_good_udp";
    gnet_property->props[227].desc = _("Whether we meet the UDP requirements to become an Ultra node.");
    gnet_property->props[227].ev_changed = event_new("up_req_good_udp_changed");
    gnet_property->props[227].save = FALSE;
    gnet_property->props[227].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[227].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[227].data.boolean.def   = (void *) &gnet_property_variable_up_req_good_udp_default;
    gnet_property->props[227].data.boolean.value = (void *) &gnet_property_variable_up_req_good_udp;
     ...
     * General data:
     */
    gnet_property->props[228].name = "search_queue_size";
    gnet_property->props[228].desc = _("Size of the search queue holding the locally generated queries before they are sent on a given connection.  When full, the oldest query is dropped without being sent.  Set it so that it is slightly larger than the amount of opened searches.");
    gnet_property->props[228].ev_changed = event_new("search_queue_size_changed");
    gnet_property->props[228].save = TRUE;
    gnet_property->props[228].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[228].type               = PROP_TYPE_GUINT32;
    gnet_property->props[228].data.guint32.def   = (void *) &gnet_property_variable_search_queue_size_default;
    gnet_property->props[228].data.guint32.value = (void *) &gnet_property_variable_search_queue_size;
    gnet_property->props[228].data.guint32.choices = NULL;
    gnet_property->props[228].data.guint32.max   = 512;
    gnet_property->props[228].data.guint32.min   = 32;
     ...
     * General data:
     */
    gnet_property->props[229].name = "search_queue_spacing";
    gnet_property->props[229].desc = _("Minimum amount of seconds between two consecutive queries sent to a given connection (for locally generated queries only!). The larger the value, the less negative impact it has on the network.");
    gnet_property->props[229].ev_changed = event_new("search_queue_spacing_changed");
    gnet_property->props[229].save = TRUE;
    gnet_property->props[229].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[229].type               = PROP_TYPE_GUINT32;
    gnet_property->props[229].data.guint32.def   = (void *) &gnet_property_variable_search_queue_spacing_default;
    gnet_property->props[229].data.guint32.value = (void *) &gnet_property_variable_search_queue_spacing;
    gnet_property->props[229].data.guint32.choices = NULL;
    gnet_property->props[229].data.guint32.max   = 60;
    gnet_property->props[229].data.guint32.min   = 10;
     ...
     * General data:
     */
    gnet_property->props[230].name = "enable_shell";
    gnet_property->props[230].desc = _("Whether connection to gtk-gnutella via the 'shell' control interface should be allowed.");
    gnet_property->props[230].ev_changed = event_new("enable_shell_changed");
    gnet_property->props[230].save = TRUE;
    gnet_property->props[230].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[230].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[230].data.boolean.def   = (void *) &gnet_property_variable_enable_shell_default;
    gnet_property->props[230].data.boolean.value = (void *) &gnet_property_variable_enable_shell;
     ...
     * General data:
     */
    gnet_property->props[231].name = "remote_shell_timeout";
    gnet_property->props[231].desc = _("Amount of seconds until an idle remote shell session gets disconnected. If set to zero, no timeout occurs.");
    gnet_property->props[231].ev_changed = event_new("remote_shell_timeout_changed");
    gnet_property->props[231].save = TRUE;
    gnet_property->props[231].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[231].type               = PROP_TYPE_GUINT32;
    gnet_property->props[231].data.guint32.def   = (void *) &gnet_property_variable_remote_shell_timeout_default;
    gnet_property->props[231].data.guint32.value = (void *) &gnet_property_variable_remote_shell_timeout;
    gnet_property->props[231].data.guint32.choices = NULL;
    gnet_property->props[231].data.guint32.max   = 31536000;
    gnet_property->props[231].data.guint32.min   = 0;
     ...
     * General data:
     */
    gnet_property->props[232].name = "entry_removal_timeout";
    gnet_property->props[232].desc = _("Amount of seconds to leave 'dead' entries around so that they can still be displayed by the GUI along with the termination status.");
    gnet_property->props[232].ev_changed = event_new("entry_removal_timeout_changed");
    gnet_property->props[232].save = TRUE;
    gnet_property->props[232].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[232].type               = PROP_TYPE_GUINT32;
    gnet_property->props[232].data.guint32.def   = (void *) &gnet_property_variable_entry_removal_timeout_default;
    gnet_property->props[232].data.guint32.value = (void *) &gnet_property_variable_entry_removal_timeout;
    gnet_property->props[232].data.guint32.choices = NULL;
    gnet_property->props[232].data.guint32.max   = 60;
    gnet_property->props[232].data.guint32.min   = 1;
     ...
     * General data:
     */
    gnet_property->props[233].name = "node_watch_similar_queries";
    gnet_property->props[233].desc = _("Whether gtk-gnutella should actively monitor query strings by TTL and hop count and drop duplicates.  Only applies when not running as a leaf node, and only for queries with hop count > 0, i.e. not from our immediate neighbor.  Dropped queries will be accounted for in the 'Message throttle' counter.");
    gnet_property->props[233].ev_changed = event_new("node_watch_similar_queries_changed");
    gnet_property->props[233].save = TRUE;
    gnet_property->props[233].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[233].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[233].data.boolean.def   = (void *) &gnet_property_variable_node_watch_similar_queries_default;
    gnet_property->props[233].data.boolean.value = (void *) &gnet_property_variable_node_watch_similar_queries;
     ...
     * General data:
     */
    gnet_property->props[234].name = "node_queries_half_life";
    gnet_property->props[234].desc = _("Half the duration during which gtk-gnutella should remember the recently relayed queries by TTL and hop count.  The default value of 5 should be just fine, but you can experiment with different settings if you want.  The higher it is set, the more likely you are to drop legitimate queries, so be careful.");
    gnet_property->props[234].ev_changed = event_new("node_queries_half_life_changed");
    gnet_property->props[234].save = TRUE;
    gnet_property->props[234].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[234].type               = PROP_TYPE_GUINT32;
    gnet_property->props[234].data.guint32.def   = (void *) &gnet_property_variable_node_queries_half_life_default;
    gnet_property->props[234].data.guint32.value = (void *) &gnet_property_variable_node_queries_half_life;
    gnet_property->props[234].data.guint32.choices = NULL;
    gnet_property->props[234].data.guint32.max   = 10;
     ...
     * General data:
     */
    gnet_property->props[236].name = "library_rescan_started";
    gnet_property->props[236].desc = _("Time at which we started the last scan of the library.");
    gnet_property->props[236].ev_changed = event_new("library_rescan_started_changed");
    gnet_property->props[236].save = FALSE;
    gnet_property->props[236].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[236].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[236].data.timestamp.def   = (void *) &gnet_property_variable_library_rescan_started_default;
    gnet_property->props[236].data.timestamp.value = (void *) &gnet_property_variable_library_rescan_started;
     ...
     * General data:
     */
    gnet_property->props[237].name = "library_rescan_finished";
    gnet_property->props[237].desc = _("Time at which the last scan of the library finished.");
    gnet_property->props[237].ev_changed = event_new("library_rescan_finished_changed");
    gnet_property->props[237].save = FALSE;
    gnet_property->props[237].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[237].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[237].data.timestamp.def   = (void *) &gnet_property_variable_library_rescan_finished_default;
    gnet_property->props[237].data.timestamp.value = (void *) &gnet_property_variable_library_rescan_finished;
     ...
     * General data:
     */
    gnet_property->props[238].name = "library_rescan_duration";
    gnet_property->props[238].desc = _("The number of seconds the last scan of the library took.");
    gnet_property->props[238].ev_changed = event_new("library_rescan_duration_changed");
    gnet_property->props[238].save = FALSE;
    gnet_property->props[238].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[238].type               = PROP_TYPE_GUINT32;
    gnet_property->props[238].data.guint32.def   = (void *) &gnet_property_variable_library_rescan_duration_default;
    gnet_property->props[238].data.guint32.value = (void *) &gnet_property_variable_library_rescan_duration;
     ...
     * General data:
     */
    gnet_property->props[239].name = "qrp_indexing_started";
    gnet_property->props[239].desc = _("Time at which we started shared file indexing.");
    gnet_property->props[239].ev_changed = event_new("qrp_indexing_started_changed");
    gnet_property->props[239].save = FALSE;
    gnet_property->props[239].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[239].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[239].data.timestamp.def   = (void *) &gnet_property_variable_qrp_indexing_started_default;
    gnet_property->props[239].data.timestamp.value = (void *) &gnet_property_variable_qrp_indexing_started;
     ...
     * General data:
     */
    gnet_property->props[240].name = "qrp_indexing_duration";
    gnet_property->props[240].desc = _("Time spent indexing shared files.");
    gnet_property->props[240].ev_changed = event_new("qrp_indexing_duration_changed");
    gnet_property->props[240].save = FALSE;
    gnet_property->props[240].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[240].type               = PROP_TYPE_GUINT32;
    gnet_property->props[240].data.guint32.def   = (void *) &gnet_property_variable_qrp_indexing_duration_default;
    gnet_property->props[240].data.guint32.value = (void *) &gnet_property_variable_qrp_indexing_duration;
     ...
     * General data:
     */
    gnet_property->props[241].name = "qrp_memory";
    gnet_property->props[241].desc = _("Memory used by the QRP tables");
    gnet_property->props[241].ev_changed = event_new("qrp_memory_changed");
    gnet_property->props[241].save = FALSE;
    gnet_property->props[241].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[241].type               = PROP_TYPE_GUINT32;
    gnet_property->props[241].data.guint32.def   = (void *) &gnet_property_variable_qrp_memory_default;
    gnet_property->props[241].data.guint32.value = (void *) &gnet_property_variable_qrp_memory;
     ...
     * General data:
     */
    gnet_property->props[242].name = "qrp_timestamp";
    gnet_property->props[242].desc = _("Time at which we started query routing table generation.");
    gnet_property->props[242].ev_changed = event_new("qrp_timestamp_changed");
    gnet_property->props[242].save = FALSE;
    gnet_property->props[242].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[242].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[242].data.timestamp.def   = (void *) &gnet_property_variable_qrp_timestamp_default;
    gnet_property->props[242].data.timestamp.value = (void *) &gnet_property_variable_qrp_timestamp;
     ...
     * General data:
     */
    gnet_property->props[243].name = "qrp_computation_time";
    gnet_property->props[243].desc = _("Time spent computing the QRP table, in seconds.");
    gnet_property->props[243].ev_changed = event_new("qrp_computation_time_changed");
    gnet_property->props[243].save = FALSE;
    gnet_property->props[243].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[243].type               = PROP_TYPE_GUINT32;
    gnet_property->props[243].data.guint32.def   = (void *) &gnet_property_variable_qrp_computation_time_default;
    gnet_property->props[243].data.guint32.value = (void *) &gnet_property_variable_qrp_computation_time;
     ...
     * General data:
     */
    gnet_property->props[244].name = "qrp_patch_timestamp";
    gnet_property->props[244].desc = _("Time at which we started computing our QRP patch.");
    gnet_property->props[244].ev_changed = event_new("qrp_patch_timestamp_changed");
    gnet_property->props[244].save = FALSE;
    gnet_property->props[244].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[244].type               = PROP_TYPE_TIMESTAMP;
    gnet_property->props[244].data.timestamp.def   = (void *) &gnet_property_variable_qrp_patch_timestamp_default;
    gnet_property->props[244].data.timestamp.value = (void *) &gnet_property_variable_qrp_patch_timestamp;
     ...
     * General data:
     */
    gnet_property->props[245].name = "qrp_patch_computation_time";
    gnet_property->props[245].desc = _("Time spent computing the QRP table patch, in seconds.");
    gnet_property->props[245].ev_changed = event_new("qrp_patch_computation_time_changed");
    gnet_property->props[245].save = FALSE;
    gnet_property->props[245].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[245].type               = PROP_TYPE_GUINT32;
    gnet_property->props[245].data.guint32.def   = (void *) &gnet_property_variable_qrp_patch_computation_time_default;
    gnet_property->props[245].data.guint32.value = (void *) &gnet_property_variable_qrp_patch_computation_time;
     ...
     * General data:
     */
    gnet_property->props[246].name = "qrp_generation";
    gnet_property->props[246].desc = _("Query routing table generation number.");
    gnet_property->props[246].ev_changed = event_new("qrp_generation_changed");
    gnet_property->props[246].save = FALSE;
    gnet_property->props[246].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[246].type               = PROP_TYPE_GUINT32;
    gnet_property->props[246].data.guint32.def   = (void *) &gnet_property_variable_qrp_generation_default;
    gnet_property->props[246].data.guint32.value = (void *) &gnet_property_variable_qrp_generation;
     ...
     * General data:
     */
    gnet_property->props[247].name = "qrp_slots";
    gnet_property->props[247].desc = _("Amount of slots used by our QRP table.");
    gnet_property->props[247].ev_changed = event_new("qrp_slots_changed");
    gnet_property->props[247].save = FALSE;
    gnet_property->props[247].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[247].type               = PROP_TYPE_GUINT32;
    gnet_property->props[247].data.guint32.def   = (void *) &gnet_property_variable_qrp_slots_default;
    gnet_property->props[247].data.guint32.value = (void *) &gnet_property_variable_qrp_slots;
     ...
     * General data:
     */
    gnet_property->props[248].name = "qrp_slots_filled";
    gnet_property->props[248].desc = _("Amount of slots filled within our QRP table.");
    gnet_property->props[248].ev_changed = event_new("qrp_slots_filled_changed");
    gnet_property->props[248].save = FALSE;
    gnet_property->props[248].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[248].type               = PROP_TYPE_GUINT32;
    gnet_property->props[248].data.guint32.def   = (void *) &gnet_property_variable_qrp_slots_filled_default;
    gnet_property->props[248].data.guint32.value = (void *) &gnet_property_variable_qrp_slots_filled;
     ...
     * General data:
     */
    gnet_property->props[249].name = "qrp_fill_ratio";
    gnet_property->props[249].desc = _("Percentage of slots filled within our QRP table.");
    gnet_property->props[249].ev_changed = event_new("qrp_fill_ratio_changed");
    gnet_property->props[249].save = FALSE;
    gnet_property->props[249].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[249].type               = PROP_TYPE_GUINT32;
    gnet_property->props[249].data.guint32.def   = (void *) &gnet_property_variable_qrp_fill_ratio_default;
    gnet_property->props[249].data.guint32.value = (void *) &gnet_property_variable_qrp_fill_ratio;
     ...
     * General data:
     */
    gnet_property->props[250].name = "qrp_conflict_ratio";
    gnet_property->props[250].desc = _("Percentage of hashing conflicts whilst inserting data in our QRP table.");
    gnet_property->props[250].ev_changed = event_new("qrp_conflict_ratio_changed");
    gnet_property->props[250].save = FALSE;
    gnet_property->props[250].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[250].type               = PROP_TYPE_GUINT32;
    gnet_property->props[250].data.guint32.def   = (void *) &gnet_property_variable_qrp_conflict_ratio_default;
    gnet_property->props[250].data.guint32.value = (void *) &gnet_property_variable_qrp_conflict_ratio;
     ...
     * General data:
     */
    gnet_property->props[251].name = "qrp_hashed_keywords";
    gnet_property->props[251].desc = _("Amount of hashed keywords in our QRP table.");
    gnet_property->props[251].ev_changed = event_new("qrp_hashed_keywords_changed");
    gnet_property->props[251].save = FALSE;
    gnet_property->props[251].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[251].type               = PROP_TYPE_GUINT32;
    gnet_property->props[251].data.guint32.def   = (void *) &gnet_property_variable_qrp_hashed_keywords_default;
    gnet_property->props[251].data.guint32.value = (void *) &gnet_property_variable_qrp_hashed_keywords;
     ...
     * General data:
     */
    gnet_property->props[252].name = "qrp_patch_raw_length";
    gnet_property->props[252].desc = _("Total raw size of the QRP table patch, in bytes.");
    gnet_property->props[252].ev_changed = event_new("qrp_patch_raw_length_changed");
    gnet_property->props[252].save = FALSE;
    gnet_property->props[252].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[252].type               = PROP_TYPE_GUINT32;
    gnet_property->props[252].data.guint32.def   = (void *) &gnet_property_variable_qrp_patch_raw_length_default;
    gnet_property->props[252].data.guint32.value = (void *) &gnet_property_variable_qrp_patch_raw_length;
     ...
     * General data:
     */
    gnet_property->props[253].name = "qrp_patch_length";
    gnet_property->props[253].desc = _("Final QRP table patch length, after possible compression.");
    gnet_property->props[253].ev_changed = event_new("qrp_patch_length_changed");
    gnet_property->props[253].save = FALSE;
    gnet_property->props[253].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[253].type               = PROP_TYPE_GUINT32;
    gnet_property->props[253].data.guint32.def   = (void *) &gnet_property_variable_qrp_patch_length_default;
    gnet_property->props[253].data.guint32.value = (void *) &gnet_property_variable_qrp_patch_length;
     ...
     * General data:
     */
    gnet_property->props[254].name = "qrp_patch_comp_ratio";
    gnet_property->props[254].desc = _("QRP table patch compression ratio, in percent, 0 means none.");
    gnet_property->props[254].ev_changed = event_new("qrp_patch_comp_ratio_changed");
    gnet_property->props[254].save = FALSE;
    gnet_property->props[254].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[254].type               = PROP_TYPE_GUINT32;
    gnet_property->props[254].data.guint32.def   = (void *) &gnet_property_variable_qrp_patch_comp_ratio_default;
    gnet_property->props[254].data.guint32.value = (void *) &gnet_property_variable_qrp_patch_comp_ratio;
     ...
     * General data:
     */
    gnet_property->props[255].name = "ancient_version_left_days";
    gnet_property->props[255].desc = _("Indicates that gtk-gnutella will expire in that many days.");
    gnet_property->props[255].ev_changed = event_new("ancient_version_left_days_changed");
    gnet_property->props[255].save = FALSE;
    gnet_property->props[255].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[255].type               = PROP_TYPE_GUINT32;
    gnet_property->props[255].data.guint32.def   = (void *) &gnet_property_variable_ancient_version_left_days_default;
    gnet_property->props[255].data.guint32.value = (void *) &gnet_property_variable_ancient_version_left_days;
    ...
    gnet_property->props[268].desc = _("If set to TRUE, the global hostiles.txt is used as well as the private $GTK_GNUTELLA_DIR/hostiles.txt. This allows to separate your private ban list from the global one distributed with gtk-gnutella.");
    ...
    gnet_property->props[277].data.guint32.max   = 131072;
     ...
     * General data:
     */
    gnet_property->props[296].name = "experimental_download_data_ignoring";
    gnet_property->props[296].desc = _("This is an interim property.");
    gnet_property->props[296].ev_changed = event_new("experimental_download_data_ignoring_changed");
    gnet_property->props[296].save = TRUE;
    gnet_property->props[296].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[296].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[296].data.boolean.def   = (void *) &gnet_property_variable_experimental_download_data_ignoring_default;
    gnet_property->props[296].data.boolean.value = (void *) &gnet_property_variable_experimental_download_data_ignoring;
