...
gnet_prop_init(void) {
     ...
     * General data:
     */
    gnet_property->props[88].name = "use_netmasks";
    gnet_property->props[88].desc = _("Try to connect to local networks first.");
    gnet_property->props[88].ev_changed = event_new("use_netmasks_changed");
    gnet_property->props[88].save = TRUE;
    gnet_property->props[88].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[88].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[88].data.boolean.def   = &use_netmasks_def;
    gnet_property->props[88].data.boolean.value = &use_netmasks;
     ...
     * General data:
     */
    gnet_property->props[89].name = "allow_private_network_connection";
    gnet_property->props[89].desc = _("Check this button if you want to use Gtk-Gnutella on your Local Area Network. RFC1918 will be ignored.");
    gnet_property->props[89].ev_changed = event_new("allow_private_network_connection_changed");
    gnet_property->props[89].save = TRUE;
    gnet_property->props[89].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[89].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[89].data.boolean.def   = &allow_private_network_connection_def;
    gnet_property->props[89].data.boolean.value = &allow_private_network_connection;
     ...
     * General data:
     */
    gnet_property->props[90].name = "use_ip_tos";
    gnet_property->props[90].desc = _("Check this button if you want Gtk-Gnutella to use IP TOS to differentiate interactive, normal and bulk data. This is probably a good idea in most cases, and can particularly help with badly misconfigured hosts, LANs, and ISPs.");
    gnet_property->props[90].ev_changed = event_new("use_ip_tos_changed");
    gnet_property->props[90].save = TRUE;
    gnet_property->props[90].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[90].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[90].data.boolean.def   = &use_ip_tos_def;
    gnet_property->props[90].data.boolean.value = &use_ip_tos;
     ...
     * General data:
     */
    gnet_property->props[91].name = "download_delete_aborted";
    gnet_property->props[91].desc = _("Remove files of aborted downloads from disk.");
    gnet_property->props[91].ev_changed = event_new("download_delete_aborted_changed");
    gnet_property->props[91].save = TRUE;
    gnet_property->props[91].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[91].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[91].data.boolean.def   = &download_delete_aborted_def;
    gnet_property->props[91].data.boolean.value = &download_delete_aborted;
     ...
     * General data:
     */
    gnet_property->props[92].name = "proxy_auth";
    gnet_property->props[92].desc = _("Use username and password to authenticate to proxy.");
    gnet_property->props[92].ev_changed = event_new("proxy_auth_changed");
    gnet_property->props[92].save = TRUE;
    gnet_property->props[92].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[92].type               = PROP_TYPE_BOOLEAN;
    gnet_property->props[92].data.boolean.def   = &proxy_auth_def;
    gnet_property->props[92].data.boolean.value = &proxy_auth;
     ...
     * General data:
     */
    gnet_property->props[93].name = "socks_user";
    gnet_property->props[93].desc = _("Username for proxy.");
    gnet_property->props[93].ev_changed = event_new("socks_user_changed");
    gnet_property->props[93].save = TRUE;
    gnet_property->props[93].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[93].type               = PROP_TYPE_STRING;
    gnet_property->props[93].data.string.def    = &socks_user_def;
    gnet_property->props[93].data.string.value  = &socks_user;
     ...
     * General data:
     */
    gnet_property->props[94].name = "socks_pass";
    gnet_property->props[94].desc = _("Password for proxy.");
    gnet_property->props[94].ev_changed = event_new("socks_pass_changed");
    gnet_property->props[94].save = TRUE;
    gnet_property->props[94].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[94].type               = PROP_TYPE_STRING;
    gnet_property->props[94].data.string.def    = &socks_pass_def;
    gnet_property->props[94].data.string.value  = &socks_pass;
     ...
     * General data:
     */
    gnet_property->props[95].name = "proxy_addr";
    gnet_property->props[95].desc = _("Address of the proxy.");
    gnet_property->props[95].ev_changed = event_new("proxy_addr_changed");
    gnet_property->props[95].save = FALSE;
    gnet_property->props[95].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[95].type               = PROP_TYPE_STRING;
    gnet_property->props[95].data.string.def    = &proxy_addr_def;
    gnet_property->props[95].data.string.value  = &proxy_addr;
     ...
     * General data:
     */
    gnet_property->props[96].name = "proxy_hostname";
    gnet_property->props[96].desc = _("Hostname of the proxy.");
    gnet_property->props[96].ev_changed = event_new("proxy_hostname_changed");
    gnet_property->props[96].save = TRUE;
    gnet_property->props[96].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[96].type               = PROP_TYPE_STRING;
    gnet_property->props[96].data.string.def    = &proxy_hostname_def;
    gnet_property->props[96].data.string.value  = &proxy_hostname;
     ...
     * General data:
     */
    gnet_property->props[97].name = "proxy_port";
    gnet_property->props[97].desc = _("TCP Port the proxy is listening on.");
    gnet_property->props[97].ev_changed = event_new("proxy_port_changed");
    gnet_property->props[97].save = TRUE;
    gnet_property->props[97].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[97].type               = PROP_TYPE_GUINT32;
    gnet_property->props[97].data.guint32.def   = &proxy_port_def;
    gnet_property->props[97].data.guint32.value = &proxy_port;
    gnet_property->props[97].data.guint32.choices = NULL;
    gnet_property->props[97].data.guint32.max   = 0xFFFF;
    gnet_property->props[97].data.guint32.min   = 0x0000;
     ...
     * General data:
     */
    gnet_property->props[98].name = "proxy_protocol";
    gnet_property->props[98].desc = _("Protocol the proxy uses.");
    gnet_property->props[98].ev_changed = event_new("proxy_protocol_changed");
    gnet_property->props[98].save = TRUE;
    gnet_property->props[98].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[98].type               = PROP_TYPE_MULTICHOICE;
    gnet_property->props[98].data.guint32.def   = &proxy_protocol_def;
    gnet_property->props[98].data.guint32.value = &proxy_protocol;
    gnet_property->props[98].data.guint32.max   = 0xFFFFFFFF;
    gnet_property->props[98].data.guint32.min   = 0x00000000;
    gnet_property->props[98].data.guint32.choices = proxy_protocol_choices;
     ...
     * General data:
     */
    gnet_property->props[99].name = "network_protocol";
    gnet_property->props[99].desc = _("Network protocols to use.");
    gnet_property->props[99].ev_changed = event_new("network_protocol_changed");
    gnet_property->props[99].save = TRUE;
    gnet_property->props[99].vector_size = 1;

    /* Type specific data: */
    gnet_property->props[99].type               = PROP_TYPE_MULTICHOICE;
    gnet_property->props[99].data.guint32.def   = &network_protocol_def;
    gnet_property->props[99].data.guint32.value = &network_protocol;
    gnet_property->props[99].data.guint32.max   = 0xFFFFFFFF;
    gnet_property->props[99].data.guint32.min   = 0x00000000;
    gnet_property->props[99].data.guint32.choices = network_protocol_choices;
