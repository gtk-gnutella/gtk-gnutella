 ...
 * Public interface.
 */
#define statusbar_gui_message(t, format...) \
    statusbar_gui_push(SB_MESSAGE, scid_info, t, format);

#define statusbar_gui_warning(t, format...) \
    statusbar_gui_push(SB_WARNING, scid_warn, t, format);
