...
#define GTA_REVISION "beta"			/**< unstable, beta, stable */
#define GTA_REVCHAR "b"			/**< u - unstable, b - beta, none - stable */
#define GTA_RELEASE "2005-12-11"	/**< ISO 8601 format YYYY-MM-DD */
