...
prop_set_t *gui_prop_init(void) {
     ...
     * General data:
     */
    gui_property->props[20].name = "window_coords";
    gui_property->props[20].desc = "Position and size of the main window";
    ...
    gui_property->props[20].data.guint32.def   = window_coords_def;
    gui_property->props[20].data.guint32.value = window_coords;
     ...
     * General data:
     */
    gui_property->props[21].name = "filter_dlg_coords";
    gui_property->props[21].desc = "Position and size of the filter dialog";
    ...
    gui_property->props[21].data.guint32.def   = filter_dlg_coords_def;
    gui_property->props[21].data.guint32.value = filter_dlg_coords;
     ...
     * General data:
     */
    gui_property->props[22].name = "downloads_divider_pos";
    gui_property->props[22].desc = "Position of the divider in the downloads panel";
    ...
    gui_property->props[22].data.guint32.def   = &downloads_divider_pos_def;
    gui_property->props[22].data.guint32.value = &downloads_divider_pos;
     ...
     * General data:
     */
    gui_property->props[23].name = "main_divider_pos";
    gui_property->props[23].desc = "Size of the sidebar";
    ...
    gui_property->props[23].data.guint32.def   = &main_divider_pos_def;
    gui_property->props[23].data.guint32.value = &main_divider_pos;
     ...
     * General data:
     */
    gui_property->props[24].name = "gnet_stats_divider_pos";
    gui_property->props[24].desc = "Position of the divider in the gnet stats pane";
    ...
    gui_property->props[24].data.guint32.def   = &gnet_stats_divider_pos_def;
    gui_property->props[24].data.guint32.value = &gnet_stats_divider_pos;
     ...
     * General data:
     */
    gui_property->props[25].name = "side_divider_pos";
    gui_property->props[25].desc = "Size of the menu in the sidebar";
    ...
    gui_property->props[25].data.guint32.def   = &side_divider_pos_def;
    gui_property->props[25].data.guint32.value = &side_divider_pos;
     ...
     * General data:
     */
    gui_property->props[26].name = "search_max_results";
    gui_property->props[26].desc = "Maximum number of results to show in any search";
    ...
    gui_property->props[26].data.guint32.def   = &search_max_results_def;
    gui_property->props[26].data.guint32.value = &search_max_results;
    gui_property->props[26].data.guint32.max   = 100000;
    gui_property->props[26].data.guint32.min   = 10;
     ...
     * General data:
     */
    gui_property->props[27].name = "gui_debug";
    gui_property->props[27].desc = "Debug level for the gui";
    ...
    gui_property->props[27].data.guint32.def   = &gui_debug_def;
    gui_property->props[27].data.guint32.value = &gui_debug;
    gui_property->props[27].data.guint32.max   = 20;
    gui_property->props[27].data.guint32.min   = 0;
     ...
     * General data:
     */
    gui_property->props[28].name = "filter_main_divider_pos";
    gui_property->props[28].desc = "Size of the filter tree in the filter dialog";
    ...
    gui_property->props[28].data.guint32.def   = &filter_main_divider_pos_def;
    gui_property->props[28].data.guint32.value = &filter_main_divider_pos;
     ...
     * General data:
     */
    gui_property->props[29].name = "search_results_show_tabs";
    gui_property->props[29].desc = "Show tabs or search list";
    ...
    gui_property->props[29].data.boolean.def   = &search_results_show_tabs_def;
    gui_property->props[29].data.boolean.value = &search_results_show_tabs;
     ...
     * General data:
     */
    gui_property->props[30].name = "toolbar_visible";
    gui_property->props[30].desc = "Display toolbar";
    ...
    gui_property->props[30].data.boolean.def   = &toolbar_visible_def;
    gui_property->props[30].data.boolean.value = &toolbar_visible;
     ...
     * General data:
     */
    gui_property->props[31].name = "statusbar_visible";
    gui_property->props[31].desc = "Display statusbar";
    ...
    gui_property->props[31].data.boolean.def   = &statusbar_visible_def;
    gui_property->props[31].data.boolean.value = &statusbar_visible;
     ...
     * General data:
     */
    gui_property->props[32].name = "progressbar_uploads_visible";
    gui_property->props[32].desc = "Display upload statistics in sidebar";
    ...
    gui_property->props[32].data.boolean.def   = &progressbar_uploads_visible_def;
    gui_property->props[32].data.boolean.value = &progressbar_uploads_visible;
     ...
     * General data:
     */
    gui_property->props[33].name = "progressbar_downloads_visible";
    gui_property->props[33].desc = "Display download statistics in sidebar";
    ...
    gui_property->props[33].data.boolean.def   = &progressbar_downloads_visible_def;
    gui_property->props[33].data.boolean.value = &progressbar_downloads_visible;
     ...
     * General data:
     */
    gui_property->props[34].name = "progressbar_connections_visible";
    gui_property->props[34].desc = "Display connection statistics in sidebar";
    ...
    gui_property->props[34].data.boolean.def   = &progressbar_connections_visible_def;
    gui_property->props[34].data.boolean.value = &progressbar_connections_visible;
     ...
     * General data:
     */
    gui_property->props[35].name = "progressbar_bws_in_visible";
    gui_property->props[35].desc = "Display incoming HTTP traffic bandwidth usage";
    ...
    gui_property->props[35].data.boolean.def   = &progressbar_bws_in_visible_def;
    gui_property->props[35].data.boolean.value = &progressbar_bws_in_visible;
     ...
     * General data:
     */
    gui_property->props[36].name = "progressbar_bws_out_visible";
    gui_property->props[36].desc = "Display outgoing HTTP traffic bandwidth usage";
    ...
    gui_property->props[36].data.boolean.def   = &progressbar_bws_out_visible_def;
    gui_property->props[36].data.boolean.value = &progressbar_bws_out_visible;
     ...
     * General data:
     */
    gui_property->props[37].name = "progressbar_bws_gin_visible";
    gui_property->props[37].desc = "Display incoming gNet traffic bandwidth usage";
    ...
    gui_property->props[37].data.boolean.def   = &progressbar_bws_gin_visible_def;
    gui_property->props[37].data.boolean.value = &progressbar_bws_gin_visible;
     ...
     * General data:
     */
    gui_property->props[38].name = "progressbar_bws_gout_visible";
    gui_property->props[38].desc = "Display outgoing gNet traffic bandwidth usage";
    ...
    gui_property->props[38].data.boolean.def   = &progressbar_bws_gout_visible_def;
    gui_property->props[38].data.boolean.value = &progressbar_bws_gout_visible;
     ...
     * General data:
     */
    gui_property->props[39].name = "progressbar_bws_in_avg";
    gui_property->props[39].desc = "Display incoming HTTP traffic bandwidth average";
    ...
    gui_property->props[39].data.boolean.def   = &progressbar_bws_in_avg_def;
    gui_property->props[39].data.boolean.value = &progressbar_bws_in_avg;
     ...
     * General data:
     */
    gui_property->props[40].name = "progressbar_bws_out_avg";
    gui_property->props[40].desc = "Display outgoing HTTP traffic bandwidth average";
    ...
    gui_property->props[40].data.boolean.def   = &progressbar_bws_out_avg_def;
    gui_property->props[40].data.boolean.value = &progressbar_bws_out_avg;
     ...
     * General data:
     */
    gui_property->props[41].name = "progressbar_bws_gin_avg";
    gui_property->props[41].desc = "Display incoming gNet traffic bandwidth average";
    ...
    gui_property->props[41].data.boolean.def   = &progressbar_bws_gin_avg_def;
    gui_property->props[41].data.boolean.value = &progressbar_bws_gin_avg;
     ...
     * General data:
     */
    gui_property->props[42].name = "progressbar_bws_gout_avg";
    gui_property->props[42].desc = "Display outgoing gNet traffic bandwidth average";
    ...
    gui_property->props[42].data.boolean.def   = &progressbar_bws_gout_avg_def;
    gui_property->props[42].data.boolean.value = &progressbar_bws_gout_avg;
     ...
     * General data:
     */
    gui_property->props[43].name = "search_autoselect_ident";
    gui_property->props[43].desc = "When enabled autoselection only takes place if filesize matches exactly, otherwise it must be equal or greater";
    ...
    gui_property->props[43].data.boolean.def   = &search_autoselect_ident_def;
    gui_property->props[43].data.boolean.value = &search_autoselect_ident;
     ...
     * General data:
     */
    gui_property->props[44].name = "jump_to_downloads";
    gui_property->props[44].desc = "Jump to downloads screen when downloading a file";
    ...
    gui_property->props[44].data.boolean.def   = &jump_to_downloads_def;
    gui_property->props[44].data.boolean.value = &jump_to_downloads;
     ...
     * General data:
     */
    gui_property->props[45].name = "show_search_results_settings";
    gui_property->props[45].desc = "Display settings";
    ...
    gui_property->props[45].data.boolean.def   = &show_search_results_settings_def;
    gui_property->props[45].data.boolean.value = &show_search_results_settings;
     ...
     * General data:
     */
    gui_property->props[46].name = "search_autoselect_fuzzy";
    gui_property->props[46].desc = "Use fuzzy name match for autoselection";
    ...
    gui_property->props[46].data.boolean.def   = &search_autoselect_fuzzy_def;
    gui_property->props[46].data.boolean.value = &search_autoselect_fuzzy;
     ...
     * General data:
     */
    gui_property->props[47].name = "filter_default_policy";
    gui_property->props[47].desc = "Default policy for the DISPLAY filter property";
    ...
    gui_property->props[47].data.guint32.def   = &filter_default_policy_def;
    gui_property->props[47].data.guint32.value = &filter_default_policy;
    gui_property->props[47].data.guint32.max   = FILTER_PROP_STATE_DONT;
    gui_property->props[47].data.guint32.min   = FILTER_PROP_STATE_DO;
    ...
    gui_property->props[49].data.guint32.max   = 3;
     ...
     * General data:
     */
    gui_property->props[62].name = "gnet_stats_pkg_perc";
    gui_property->props[62].desc = "Show percentages instead of absolute values in the gnet stats (pkg) [GTK2]";
    ...
    gui_property->props[62].data.boolean.def   = &gnet_stats_pkg_perc_def;
    gui_property->props[62].data.boolean.value = &gnet_stats_pkg_perc;
     ...
     * General data:
     */
    gui_property->props[63].name = "gnet_stats_byte_perc";
    gui_property->props[63].desc = "Show percentages instead of absolute values in the gnet stats (byte) [GTK2]";
    ...
    gui_property->props[63].data.boolean.def   = &gnet_stats_byte_perc_def;
    gui_property->props[63].data.boolean.value = &gnet_stats_byte_perc;
    return gui_property;
}
