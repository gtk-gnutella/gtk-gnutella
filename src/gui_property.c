...
prop_set_t *gui_prop_init(void) {
     ...
     * General data:
     */
    gui_property->props[54].name = "gnet_stats_perc";
    gui_property->props[54].desc = "Show percentages instead of absolute values in the gnet stats";
    ...
    gui_property->props[54].data.boolean.def   = &gnet_stats_perc_def;
    gui_property->props[54].data.boolean.value = &gnet_stats_perc;
     ...
     * General data:
     */
    gui_property->props[55].name = "gnet_stats_bytes";
    gui_property->props[55].desc = "Show bytes instead of packages in the gnet stats";
    ...
    gui_property->props[55].data.boolean.def   = &gnet_stats_bytes_def;
    gui_property->props[55].data.boolean.value = &gnet_stats_bytes;
     ...
     * General data:
     */
    gui_property->props[56].name = "gnet_stats_drop_perc";
    gui_property->props[56].desc = "Show percentages instead of absolute values in the gnet stats (drop reasons)";
    ...
    gui_property->props[56].data.boolean.def   = &gnet_stats_drop_perc_def;
    gui_property->props[56].data.boolean.value = &gnet_stats_drop_perc;
     ...
     * General data:
     */
    gui_property->props[57].name = "widths_gnet_stats_general";
    gui_property->props[57].desc = "Widths of the columns in the gnet stats general table";
    gui_property->props[57].prop_changed_listeners = NULL;
    gui_property->props[57].save = TRUE;
    gui_property->props[57].vector_size = 2;

    /* Type specific data: */
    gui_property->props[57].type               = PROP_TYPE_GUINT32;
    gui_property->props[57].data.guint32.def   = gnet_stats_general_col_widths_def;
    gui_property->props[57].data.guint32.value = gnet_stats_general_col_widths;
     ...
     * General data:
     */
    gui_property->props[58].name = "auto_clear_completed_uploads";
    gui_property->props[58].desc = "Auto clear completed uploads";
    ...
    gui_property->props[58].data.boolean.def   = &clear_uploads_def;
    gui_property->props[58].data.boolean.value = &clear_uploads;
     ...
     * General data:
     */
    gui_property->props[59].name = "widths_gnet_stats_pkg";
    gui_property->props[59].desc = "Widths of the columns in the gnet packet stats table (pkg)[GTK2]";
    gui_property->props[59].prop_changed_listeners = NULL;
    gui_property->props[59].save = TRUE;
    gui_property->props[59].vector_size = 6;

    /* Type specific data: */
    gui_property->props[59].type               = PROP_TYPE_GUINT32;
    gui_property->props[59].data.guint32.def   = gnet_stats_pkg_col_widths_def;
    gui_property->props[59].data.guint32.value = gnet_stats_pkg_col_widths;
     ...
     * General data:
     */
    gui_property->props[60].name = "widths_gnet_stats_byte";
    gui_property->props[60].desc = "Widths of the columns in the gnet packet stats table (byte).[GTK2]";
    ...
    gui_property->props[60].data.guint32.def   = gnet_stats_byte_col_widths_def;
    gui_property->props[60].data.guint32.value = gnet_stats_byte_col_widths;
     ...
     * General data:
     */
    gui_property->props[61].name = "gnet_stats_pkg_perc";
    gui_property->props[61].desc = "Show percentages instead of absolute values in the gnet stats (pkg) [GTK2]";
    ...
    gui_property->props[61].data.boolean.def   = &gnet_stats_pkg_perc_def;
    gui_property->props[61].data.boolean.value = &gnet_stats_pkg_perc;
     ...
     * General data:
     */
    gui_property->props[62].name = "gnet_stats_byte_perc";
    gui_property->props[62].desc = "Show percentages instead of absolute values in the gnet stats (byte) [GTK2]";
    ...
    gui_property->props[62].data.boolean.def   = &gnet_stats_byte_perc_def;
    gui_property->props[62].data.boolean.value = &gnet_stats_byte_perc;
    return gui_property;
}
