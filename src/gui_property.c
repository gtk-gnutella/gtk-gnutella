...
gboolean gnet_stats_fc_ttl_perc     = FALSE;
gboolean gnet_stats_fc_ttl_perc_def = FALSE;
gboolean gnet_stats_fc_hops_perc     = FALSE;
gboolean gnet_stats_fc_hops_perc_def = FALSE;
...
prop_set_t *gui_prop_init(void) {
     ...
     * General data:
     */
    gui_property->props[55].name = "gnet_stats_pkg_perc";
    gui_property->props[55].desc = "Show percentages instead of absolute values in the gnet stats (packet display)";
    ...
    gui_property->props[55].data.boolean.def   = &gnet_stats_pkg_perc_def;
    gui_property->props[55].data.boolean.value = &gnet_stats_pkg_perc;
     ...
     * General data:
     */
    gui_property->props[56].name = "gnet_stats_byte_perc";
    gui_property->props[56].desc = "Show percentages instead of absolute values in the gnet stats (bytes display)";
    ...
    gui_property->props[56].data.boolean.def   = &gnet_stats_byte_perc_def;
    gui_property->props[56].data.boolean.value = &gnet_stats_byte_perc;
     ...
     * General data:
     */
    gui_property->props[57].name = "gnet_stats_fc_ttl_perc";
    gui_property->props[57].desc = "Show percentages instead of absolute values in the gnet stats (flow control ttl display)";
    ...
    gui_property->props[57].data.boolean.def   = &gnet_stats_fc_ttl_perc_def;
    gui_property->props[57].data.boolean.value = &gnet_stats_fc_ttl_perc;
     ...
     * General data:
     */
    gui_property->props[58].name = "gnet_stats_fc_hops_perc";
    gui_property->props[58].desc = "Show percentages instead of absolute values in the gnet stats (flow control hops display)";
    ...
    gui_property->props[58].data.boolean.def   = &gnet_stats_fc_hops_perc_def;
    gui_property->props[58].data.boolean.value = &gnet_stats_fc_hops_perc;
