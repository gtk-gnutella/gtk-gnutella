...
gpointer walloc_track(size_t size, char *file, int line);
gpointer walloc0_track(size_t size, char *file, int line);
gpointer wcopy_track(gconstpointer, size_t size, char *file, int line);
