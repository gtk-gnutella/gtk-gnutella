...
create_main_window (void)
{
  ...
  gtk_box_pack_start (GTK_BOX (hbox9351), frame_search_media_type, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox9351), frame152, TRUE, TRUE, 0);
