...
general_type_str(gint value)
{
	static const char * const strs[] = {
		...
		N_("Semi-reliable UDP extra acknowledgment requests sent"),
		N_("Semi-reliable UDP too many extra acknowledgment requests sent"),
		N_("Semi-reliable UDP extra negative acknowledgments received"),
		N_("Semi-reliable UDP acknowledgments received after extra requests"),
		...
		N_("Semi-reliable UDP extra acknowledgment requests received"),
		N_("Semi-reliable UDP invalid extra acknowledgment requests"),
		N_("Semi-reliable UDP extra acknowledgment requests whilst lingering"),
