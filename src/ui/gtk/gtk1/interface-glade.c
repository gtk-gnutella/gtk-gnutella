...
create_main_window (void)
{
  ...
  gtk_container_add (GTK_CONTAINER (notebook_main), vbox109);
  ...
  gtk_container_add (GTK_CONTAINER (notebook_main), vbox16);
  ...
  gtk_container_add (GTK_CONTAINER (notebook_main), vbox15);
