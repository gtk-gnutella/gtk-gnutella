...
gchar *s = N_("_Stats");
gchar *s = N_("_Hostcache");
gchar *s = N_("_Preferences");
gchar *s = N_("_Quit");
gchar *s = N_("_Uploads");
gchar *s = N_("_Transfers");
gchar *s = N_("_History");
gchar *s = N_("_Downloads");
gchar *s = N_("_Files");
gchar *s = N_("_Active");
gchar *s = N_("_Queue");
gchar *s = N_("_Search");
...
gchar *s = N_("show _Toolbar");
gchar *s = N_("show _Sidebar");
gchar *s = N_("show _Navigation Tree");
...
gchar *s = N_("_Passive");
gchar *s = N_("GnutellaNet connections");
gchar *s = N_("Host");
gchar *s = N_("Loc");
gchar *s = N_("Flags");
...
gchar *s = N_("[Gnet]");
gchar *s = N_("Message/flow control stats");
gchar *s = N_("Type");
gchar *s = N_("Count");
gchar *s = N_("Reason");
gchar *s = N_("Count");
...
gchar *s = N_("[Gnet Stats]");
gchar *s = N_("Hostcache statistics");
gchar *s = N_("Cache");
gchar *s = N_("Hosts");
gchar *s = N_("Hits");
gchar *s = N_("Misses");
...
gchar *s = N_("[Upload Stats]");
gchar *s = N_("Files to get");
gchar *s = N_("File");
gchar *s = N_("Size");
gchar *s = N_("Done");
gchar *s = N_("Sources");
...
gchar *s = N_("Alternate filenames");
...
gchar *s = N_("queued");
gchar *s = N_(")");
gchar *s = N_("Show settings");
gchar *s = N_("[Active]");
gchar *s = N_("Inactive sources");
gchar *s = N_("Filename");
gchar *s = N_("Host");
gchar *s = N_("Loc");
gchar *s = N_("Size");
...
gchar *s = N_("with the same urn:sha1");
gchar *s = N_("from the same host");
gchar *s = N_("Auto-download selected by...");
gchar *s = N_("name");
gchar *s = N_("urn:sha1");
gchar *s = N_("New search from selected");
gchar *s = N_("Expand all");
gchar *s = N_("Collapse all");
...
gchar *s = N_("Enable \"_shell\" control interface");
...
gchar *s = N_("Read-ahead buffer");
gchar *s = N_("bytes");
gchar *s = N_("bytes");
gchar *s = N_("Strict SHA_1 matching");
gchar *s = N_("Use fu_zzy matching");
gchar *s = N_("Fuzzy threshold");
gchar *s = N_("_Apply fuzzy filter on download mesh entries");
...
gchar *s = N_("_Quit");
gchar *s = N_("_Edit filters");
gchar *s = N_("gtk-gnutella - Frequently Asked Questions");
gchar *s = N_("Frequently Asked Questions:");
