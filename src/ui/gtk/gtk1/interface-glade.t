...
gchar *s = N_("Show _inbound HTTP traffic");
gchar *s = N_("Show _outbound HTTP traffic");
gchar *s = N_("_Gnutella traffic stats");
gchar *s = N_("Show _inbound Gnutella traffic");
gchar *s = N_("Show _outbound Gnutella traffic");
gchar *s = N_("Gnutella _leaf traffic stats");
gchar *s = N_("_auto-hide leaf traffic stats");
gchar *s = N_("Show _inbound leaf traffic");
gchar *s = N_("Show _outbound leaf traffic");
gchar *s = N_("_Help");
gchar *s = N_("_About");
...
gchar *s = N_("Hits");
gchar *s = N_("New");
gchar *s = N_("Gnutella peers");
gchar *s = N_("%v/%u Gnutella peers");
gchar *s = N_("uploads");
...
gchar *s = N_("Status");
gchar *s = N_("Sources");
gchar *s = N_("Select files by regex");
gchar *s = N_("Filter files by regex");
...
gchar *s = N_("Delete file on mismatch");
...
gchar *s = N_("Automatically clear finished files");
gchar *s = N_("Automatically clear sources when...");
...
gchar *s = N_("Uptime");
gchar *s = N_("Copy Magnet to clipboard");
...
gchar *s = N_("Size");
gchar *s = N_("Spacing");
gchar *s = N_("Gnutella timeouts (all values in seconds)");
...
gchar *s = N_("Gnutella TTL settings");
gchar *s = N_("Max _TTL");
gchar *s = N_("M_y TTL");
...
gchar *s = N_("Gnutella message size limits");
...
gchar *s = N_("[place holder]");
gchar *s = N_("[place holder]");
gchar *s = N_("Bandwidth limits for Gnutella traffic");
gchar *s = N_("General");
gchar *s = N_("KiB/s");
gchar *s = N_("KiB/s");
...
gchar *s = N_("Beautify filenames by removing needless underscores");
