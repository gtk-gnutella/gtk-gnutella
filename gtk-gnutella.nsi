...
!define PRODUCT_VERSION "0.96.9u-svn17837"
!define PRODUCT_NAME "gtk-gnutella"
!define PRODUCT_NAME_SMALL "gtk-gnutella"
!define PRODUCT_PUBLISHER "Raphael Manfredi"
...
;!endif
	...
	CreateShortCut "$SMPROGRAMS\gtk-gnutella.lnk" "$INSTDIR\gtk-gnutella.exe" "" \
		"$INSTDIR\gtk-gnutella.ico" "" SW_SHOWNORMAL "" "gtk-gnutella - Hard disk drive health inspection tool"
...
!endif
	...
	WriteRegStr HKLM "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\gtk-gnutella.ico"
...
!endif
	...
	Delete "$INSTDIR\gtk-gnutella.ico"
